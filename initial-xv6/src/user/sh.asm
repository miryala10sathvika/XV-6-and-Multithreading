...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	31e58593          	addi	a1,a1,798 # 1330 <malloc+0xea>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2d858593          	addi	a1,a1,728 # 1338 <malloc+0xf2>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	0f6080e7          	jalr	246(ra) # 1160 <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2a650513          	addi	a0,a0,678 # 1340 <malloc+0xfa>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	37a70713          	addi	a4,a4,890 # 1440 <malloc+0x1fa>
    ...
    panic("runcmd");
      ...
      e4:	26850513          	addi	a0,a0,616 # 1348 <malloc+0x102>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	24e58593          	addi	a1,a1,590 # 1350 <malloc+0x10a>
     10a:	4509                	li	a0,2
     10c:	00001097          	auipc	ra,0x1
     110:	054080e7          	jalr	84(ra) # 1160 <fprintf>
  exit(0);
     114:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     152:	21258593          	addi	a1,a1,530 # 1360 <malloc+0x11a>
     156:	4509                	li	a0,2
     158:	00001097          	auipc	ra,0x1
     15c:	008080e7          	jalr	8(ra) # 1160 <fprintf>
      exit(1);
     160:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1e8:	18c50513          	addi	a0,a0,396 # 1370 <malloc+0x12a>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28a:	fc0080e7          	jalr	-64(ra) # 1246 <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d4:	f76080e7          	jalr	-138(ra) # 1246 <malloc>
     2d8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32e:	f1c080e7          	jalr	-228(ra) # 1246 <malloc>
     332:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     374:	ed6080e7          	jalr	-298(ra) # 1246 <malloc>
     378:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37a:	4661                	li	a2,24
     37c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b6:	e94080e7          	jalr	-364(ra) # 1246 <malloc>
     3ba:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	decb8b93          	addi	s7,s7,-532 # 1398 <malloc+0x152>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	dba50513          	addi	a0,a0,-582 # 1378 <malloc+0x132>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	cfa60613          	addi	a2,a2,-774 # 13a0 <malloc+0x15a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	ceab0b13          	addi	s6,s6,-790 # 13c0 <malloc+0x17a>
  ...
  return ret;
     ...
     714:	c9850513          	addi	a0,a0,-872 # 13a8 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     776:	c3e50513          	addi	a0,a0,-962 # 13b0 <malloc+0x16a>
...
0000000000000790 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b0:	c1c60613          	addi	a2,a2,-996 # 13c8 <malloc+0x182>
     7b4:	85ce                	mv	a1,s3
     7b6:	854a                	mv	a0,s2
...
00000000000007fe <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     820:	bb4a0a13          	addi	s4,s4,-1100 # 13d0 <malloc+0x18a>
  ...
  if(peek(ps, es, ";")){
     ...
     856:	b8660613          	addi	a2,a2,-1146 # 13d8 <malloc+0x192>
     85a:	85ce                	mv	a1,s3
     85c:	854a                	mv	a0,s2
...
00000000000008a6 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8bc:	ae860613          	addi	a2,a2,-1304 # 13a0 <malloc+0x15a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ec:	b0860613          	addi	a2,a2,-1272 # 13f0 <malloc+0x1aa>
     8f0:	85ca                	mv	a1,s2
     8f2:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92e:	ab650513          	addi	a0,a0,-1354 # 13e0 <malloc+0x19a>
     932:	fffff097          	auipc	ra,0xfffff
     936:	724080e7          	jalr	1828(ra) # 56 <panic>
    panic("syntax - missing )");
     93a:	00001517          	auipc	a0,0x1
     93e:	abe50513          	addi	a0,a0,-1346 # 13f8 <malloc+0x1b2>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96a:	af270713          	addi	a4,a4,-1294 # 1458 <malloc+0x212>
...
00000000000009e2 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a16:	9fe60613          	addi	a2,a2,-1538 # 1410 <malloc+0x1ca>
     a1a:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4c:	9d058593          	addi	a1,a1,-1584 # 1418 <malloc+0x1d2>
     a50:	4509                	li	a0,2
     a52:	00000097          	auipc	ra,0x0
     a56:	70e080e7          	jalr	1806(ra) # 1160 <fprintf>
    panic("syntax");
     a5a:	00001517          	auipc	a0,0x1
     a5e:	94e50513          	addi	a0,a0,-1714 # 13a8 <malloc+0x162>
...
0000000000000a6a <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	9ac48493          	addi	s1,s1,-1620 # 1428 <malloc+0x1e2>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     abe:	976a8a93          	addi	s5,s5,-1674 # 1430 <malloc+0x1ea>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	62e080e7          	jalr	1582(ra) # 1160 <fprintf>
...
putc(int fd, char c)
{
     eb4:	1101                	addi	sp,sp,-32
     eb6:	ec06                	sd	ra,24(sp)
     eb8:	e822                	sd	s0,16(sp)
     eba:	1000                	addi	s0,sp,32
     ebc:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     ec0:	4605                	li	a2,1
     ec2:	fef40593          	addi	a1,s0,-17
     ec6:	00000097          	auipc	ra,0x0
     eca:	f3e080e7          	jalr	-194(ra) # e04 <write>
}
     ece:	60e2                	ld	ra,24(sp)
     ed0:	6442                	ld	s0,16(sp)
     ed2:	6105                	addi	sp,sp,32
     ed4:	8082                	ret

0000000000000ed6 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
     ed6:	7139                	addi	sp,sp,-64
     ed8:	fc06                	sd	ra,56(sp)
     eda:	f822                	sd	s0,48(sp)
     edc:	f426                	sd	s1,40(sp)
     ede:	f04a                	sd	s2,32(sp)
     ee0:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     ee6:	c299                	beqz	a3,eec <printint+0x16>
     ee8:	0805c963          	bltz	a1,f7a <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efc:	5d850513          	addi	a0,a0,1496 # 14d0 <digits>
     f00:	883a                	mv	a6,a4
     ...
     f20:	fec7f0e3          	bgeu	a5,a2,f00 <printint+0x2a>
  if(neg)
     f24:	00088c63          	beqz	a7,f3c <printint+0x66>
    buf[i++] = '-';
  ...
  while(--i >= 0)
     f3c:	02e05863          	blez	a4,f6c <printint+0x96>
     f40:	fc040793          	addi	a5,s0,-64
     f44:	00e78933          	add	s2,a5,a4
     f48:	fff78993          	addi	s3,a5,-1
     f4c:	99ba                	add	s3,s3,a4
     f4e:	377d                	addiw	a4,a4,-1
     f50:	1702                	slli	a4,a4,0x20
     f52:	9301                	srli	a4,a4,0x20
     f54:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     f58:	fff94583          	lbu	a1,-1(s2)
     f5c:	8526                	mv	a0,s1
     f5e:	00000097          	auipc	ra,0x0
     f62:	f56080e7          	jalr	-170(ra) # eb4 <putc>
  while(--i >= 0)
     f66:	197d                	addi	s2,s2,-1
     f68:	ff3918e3          	bne	s2,s3,f58 <printint+0x82>
}
     ...
     f78:	8082                	ret
    x = -xx;
     f7a:	40b005bb          	negw	a1,a1
    neg = 1;
     f7e:	4885                	li	a7,1
    x = -xx;
     f80:	bf85                	j	ef0 <printint+0x1a>
...
{
     f82:	7119                	addi	sp,sp,-128
     f84:	fc86                	sd	ra,120(sp)
     f86:	f8a2                	sd	s0,112(sp)
     f88:	f4a6                	sd	s1,104(sp)
     f8a:	f0ca                	sd	s2,96(sp)
     f8c:	ecce                	sd	s3,88(sp)
     f8e:	e8d2                	sd	s4,80(sp)
     f90:	e4d6                	sd	s5,72(sp)
     f92:	e0da                	sd	s6,64(sp)
     f94:	fc5e                	sd	s7,56(sp)
     f96:	f862                	sd	s8,48(sp)
     f98:	f466                	sd	s9,40(sp)
     f9a:	f06a                	sd	s10,32(sp)
     f9c:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fa4:	18090f63          	beqz	s2,1142 <vprintf+0x1c0>
     fa8:	8aaa                	mv	s5,a0
     faa:	8b32                	mv	s6,a2
     fac:	00158493          	addi	s1,a1,1
  state = 0;
     fb0:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
     ...
     fb2:	02500a13          	li	s4,37
     fb6:	4c55                	li	s8,21
     fb8:	00000c97          	auipc	s9,0x0
     fbc:	4c0c8c93          	addi	s9,s9,1216 # 1478 <malloc+0x232>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
     fc0:	02800d93          	li	s11,40
  putc(fd, 'x');
     fc4:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fc6:	00000b97          	auipc	s7,0x0
     fca:	50ab8b93          	addi	s7,s7,1290 # 14d0 <digits>
     fce:	a839                	j	fec <vprintf+0x6a>
        putc(fd, c);
     fd0:	85ca                	mv	a1,s2
     fd2:	8556                	mv	a0,s5
     fd4:	00000097          	auipc	ra,0x0
     fd8:	ee0080e7          	jalr	-288(ra) # eb4 <putc>
     fdc:	a019                	j	fe2 <vprintf+0x60>
    } else if(state == '%'){
     fde:	01498d63          	beq	s3,s4,ff8 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
     fe2:	0485                	addi	s1,s1,1
     fe4:	fff4c903          	lbu	s2,-1(s1)
     fe8:	14090d63          	beqz	s2,1142 <vprintf+0x1c0>
    if(state == 0){
     fec:	fe0999e3          	bnez	s3,fde <vprintf+0x5c>
      if(c == '%'){
     ff0:	ff4910e3          	bne	s2,s4,fd0 <vprintf+0x4e>
        state = '%';
     ff4:	89d2                	mv	s3,s4
     ff6:	b7f5                	j	fe2 <vprintf+0x60>
      if(c == 'd'){
     ff8:	11490c63          	beq	s2,s4,1110 <vprintf+0x18e>
     ffc:	f9d9079b          	addiw	a5,s2,-99
    1000:	0ff7f793          	zext.b	a5,a5
    1004:	10fc6e63          	bltu	s8,a5,1120 <vprintf+0x19e>
    1008:	f9d9079b          	addiw	a5,s2,-99
    100c:	0ff7f713          	zext.b	a4,a5
    1010:	10ec6863          	bltu	s8,a4,1120 <vprintf+0x19e>
    1014:	00271793          	slli	a5,a4,0x2
    1018:	97e6                	add	a5,a5,s9
    101a:	439c                	lw	a5,0(a5)
    ...
    1032:	ea8080e7          	jalr	-344(ra) # ed6 <printint>
    1036:	8b4a                	mv	s6,s2
      } else {
    ...
    104e:	e8c080e7          	jalr	-372(ra) # ed6 <printint>
    1052:	8b4a                	mv	s6,s2
      state = 0;
    1054:	4981                	li	s3,0
    1056:	b771                	j	fe2 <vprintf+0x60>
    ...
    106a:	e70080e7          	jalr	-400(ra) # ed6 <printint>
    106e:	8b4a                	mv	s6,s2
      state = 0;
    1070:	4981                	li	s3,0
    1072:	bf85                	j	fe2 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    1074:	008b0793          	addi	a5,s6,8
    1078:	f8f43423          	sd	a5,-120(s0)
    107c:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    1080:	03000593          	li	a1,48
    1084:	8556                	mv	a0,s5
    1086:	00000097          	auipc	ra,0x0
    108a:	e2e080e7          	jalr	-466(ra) # eb4 <putc>
  putc(fd, 'x');
    108e:	07800593          	li	a1,120
    1092:	8556                	mv	a0,s5
    1094:	00000097          	auipc	ra,0x0
    1098:	e20080e7          	jalr	-480(ra) # eb4 <putc>
    109c:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    10ae:	e0a080e7          	jalr	-502(ra) # eb4 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10b2:	0992                	slli	s3,s3,0x4
    10b4:	397d                	addiw	s2,s2,-1
    10b6:	fe0914e3          	bnez	s2,109e <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    10ba:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10be:	4981                	li	s3,0
    10c0:	b70d                	j	fe2 <vprintf+0x60>
        s = va_arg(ap, char*);
    10c2:	008b0913          	addi	s2,s6,8
    10c6:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    10ca:	02098163          	beqz	s3,10ec <vprintf+0x16a>
        while(*s != 0){
    10ce:	0009c583          	lbu	a1,0(s3)
    10d2:	c5ad                	beqz	a1,113c <vprintf+0x1ba>
          putc(fd, *s);
    10d4:	8556                	mv	a0,s5
    10d6:	00000097          	auipc	ra,0x0
    10da:	dde080e7          	jalr	-546(ra) # eb4 <putc>
          s++;
    10de:	0985                	addi	s3,s3,1
        while(*s != 0){
    10e0:	0009c583          	lbu	a1,0(s3)
    10e4:	f9e5                	bnez	a1,10d4 <vprintf+0x152>
        s = va_arg(ap, char*);
    10e6:	8b4a                	mv	s6,s2
      state = 0;
    10e8:	4981                	li	s3,0
    10ea:	bde5                	j	fe2 <vprintf+0x60>
          s = "(null)";
    10ec:	00000997          	auipc	s3,0x0
    10f0:	38498993          	addi	s3,s3,900 # 1470 <malloc+0x22a>
        while(*s != 0){
    10f4:	85ee                	mv	a1,s11
    10f6:	bff9                	j	10d4 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    10f8:	008b0913          	addi	s2,s6,8
    10fc:	000b4583          	lbu	a1,0(s6)
    1100:	8556                	mv	a0,s5
    1102:	00000097          	auipc	ra,0x0
    1106:	db2080e7          	jalr	-590(ra) # eb4 <putc>
    110a:	8b4a                	mv	s6,s2
      state = 0;
    110c:	4981                	li	s3,0
    110e:	bdd1                	j	fe2 <vprintf+0x60>
        putc(fd, c);
    1110:	85d2                	mv	a1,s4
    1112:	8556                	mv	a0,s5
    1114:	00000097          	auipc	ra,0x0
    1118:	da0080e7          	jalr	-608(ra) # eb4 <putc>
      state = 0;
    111c:	4981                	li	s3,0
    111e:	b5d1                	j	fe2 <vprintf+0x60>
        putc(fd, '%');
    1120:	85d2                	mv	a1,s4
    1122:	8556                	mv	a0,s5
    1124:	00000097          	auipc	ra,0x0
    1128:	d90080e7          	jalr	-624(ra) # eb4 <putc>
        putc(fd, c);
    112c:	85ca                	mv	a1,s2
    112e:	8556                	mv	a0,s5
    1130:	00000097          	auipc	ra,0x0
    1134:	d84080e7          	jalr	-636(ra) # eb4 <putc>
      state = 0;
    1138:	4981                	li	s3,0
    113a:	b565                	j	fe2 <vprintf+0x60>
        s = va_arg(ap, char*);
    113c:	8b4a                	mv	s6,s2
      state = 0;
    113e:	4981                	li	s3,0
    1140:	b54d                	j	fe2 <vprintf+0x60>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    1182:	e04080e7          	jalr	-508(ra) # f82 <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    11b8:	dce080e7          	jalr	-562(ra) # f82 <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11d2:	e427b783          	ld	a5,-446(a5) # 2010 <freep>
    11d6:	a02d                	j	1200 <free+0x3c>
  ...
  if(p + p->s.size == bp){
    ...
    11f2:	a091                	j	1236 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11f4:	6398                	ld	a4,0(a5)
    11f6:	00e7e463          	bltu	a5,a4,11fe <free+0x3a>
    11fa:	00e6ea63          	bltu	a3,a4,120e <free+0x4a>
{
    11fe:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1200:	fed7fae3          	bgeu	a5,a3,11f4 <free+0x30>
    1204:	6398                	ld	a4,0(a5)
    1206:	00e6e463          	bltu	a3,a4,120e <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    120a:	fee7eae3          	bltu	a5,a4,11fe <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    ...
    121e:	fae60de3          	beq	a2,a4,11d8 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    1232:	fae68ae3          	beq	a3,a4,11e6 <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
    1246:	7139                	addi	sp,sp,-64
    1248:	fc06                	sd	ra,56(sp)
    124a:	f822                	sd	s0,48(sp)
    124c:	f426                	sd	s1,40(sp)
    124e:	f04a                	sd	s2,32(sp)
    1250:	ec4e                	sd	s3,24(sp)
    1252:	e852                	sd	s4,16(sp)
    1254:	e456                	sd	s5,8(sp)
    1256:	e05a                	sd	s6,0(sp)
  ...
  if((prevp = freep) == 0){
    ...
    1272:	c515                	beqz	a0,129e <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1278:	02977f63          	bgeu	a4,s1,12b6 <malloc+0x70>
    127c:	8a4e                	mv	s4,s3
    127e:	0009871b          	sext.w	a4,s3
    1282:	6685                	lui	a3,0x1
    1284:	00d77363          	bgeu	a4,a3,128a <malloc+0x44>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1292:	00001917          	auipc	s2,0x1
    1296:	d7e90913          	addi	s2,s2,-642 # 2010 <freep>
  if(p == (char*)-1)
    129a:	5afd                	li	s5,-1
    129c:	a895                	j	1310 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    129e:	00001797          	auipc	a5,0x1
    12a2:	dea78793          	addi	a5,a5,-534 # 2088 <base>
    12a6:	00001717          	auipc	a4,0x1
    12aa:	d6f73523          	sd	a5,-662(a4) # 2010 <freep>
    12ae:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12b0:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12b4:	b7e1                	j	127c <malloc+0x36>
      if(p->s.size == nunits)
    12b6:	02e48c63          	beq	s1,a4,12ee <malloc+0xa8>
        p->s.size -= nunits;
    12ba:	4137073b          	subw	a4,a4,s3
    12be:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12c0:	02071693          	slli	a3,a4,0x20
    12c4:	01c6d713          	srli	a4,a3,0x1c
    12c8:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    12ca:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    12ce:	00001717          	auipc	a4,0x1
    12d2:	d4a73123          	sd	a0,-702(a4) # 2010 <freep>
      return (void*)(p + 1);
    ...
    12f2:	bff1                	j	12ce <malloc+0x88>
  hp->s.size = nu;
    12f4:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12f8:	0541                	addi	a0,a0,16
    12fa:	00000097          	auipc	ra,0x0
    12fe:	eca080e7          	jalr	-310(ra) # 11c4 <free>
  return freep;
    1302:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1306:	d971                	beqz	a0,12da <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1308:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    130a:	4798                	lw	a4,8(a5)
    130c:	fa9775e3          	bgeu	a4,s1,12b6 <malloc+0x70>
    if(p == freep)
    1310:	00093703          	ld	a4,0(s2)
    1314:	853e                	mv	a0,a5
    1316:	fef719e3          	bne	a4,a5,1308 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    131a:	8552                	mv	a0,s4
    131c:	00000097          	auipc	ra,0x0
    1320:	b50080e7          	jalr	-1200(ra) # e6c <sbrk>
  if(p == (char*)-1)
    1324:	fd5518e3          	bne	a0,s5,12f4 <malloc+0xae>
        return 0;
    1328:	4501                	li	a0,0
    132a:	bf45                	j	12da <malloc+0x94>
