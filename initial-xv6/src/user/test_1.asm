...
main(int argc, char *argv[]) {
  ...
  6e:	7f650513          	addi	a0,a0,2038 # 860 <malloc+0xf4>
  72:	00000097          	auipc	ra,0x0
  76:	642080e7          	jalr	1602(ra) # 6b4 <printf>
    exit(0);
  7a:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e2:	3aac8c93          	addi	s9,s9,938 # 888 <malloc+0x11c>
 ...
 4f0:	3f4b8b93          	addi	s7,s7,1012 # 8e0 <digits>
 ...
 616:	26e98993          	addi	s3,s3,622 # 880 <malloc+0x114>
        while(*s != 0){
 61a:	85ee                	mv	a1,s11
