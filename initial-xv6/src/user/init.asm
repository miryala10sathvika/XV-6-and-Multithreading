...
main(void)
{
  ...
  6e:	8be50513          	addi	a0,a0,-1858 # 928 <malloc+0x148>
  ...
  8c:	84850513          	addi	a0,a0,-1976 # 8d0 <malloc+0xf0>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	83650513          	addi	a0,a0,-1994 # 8d0 <malloc+0xf0>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	84450513          	addi	a0,a0,-1980 # 8f0 <malloc+0x110>
  ...
  d2:	83a50513          	addi	a0,a0,-1990 # 908 <malloc+0x128>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	83250513          	addi	a0,a0,-1998 # 910 <malloc+0x130>
...
putc(int fd, char c)
{
 ...
 464:	f3e080e7          	jalr	-194(ra) # 39e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 496:	51650513          	addi	a0,a0,1302 # 9a8 <digits>
 49a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 556:	3fec8c93          	addi	s9,s9,1022 # 950 <malloc+0x170>
 ...
 564:	448b8b93          	addi	s7,s7,1096 # 9a8 <digits>
 ...
 68a:	2c298993          	addi	s3,s3,706 # 948 <malloc+0x168>
        while(*s != 0){
 68e:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 8ba:	b50080e7          	jalr	-1200(ra) # 406 <sbrk>
  if(p == (char*)-1)
