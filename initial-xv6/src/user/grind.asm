...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2e650513          	addi	a0,a0,742 # 1380 <malloc+0xf0>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2d650513          	addi	a0,a0,726 # 1380 <malloc+0xf0>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	2cc50513          	addi	a0,a0,716 # 1388 <malloc+0xf8>
  ...
  chdir("/");
      ...
      da:	2d250513          	addi	a0,a0,722 # 13a8 <malloc+0x118>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	2d298993          	addi	s3,s3,722 # 13b8 <malloc+0x128>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2c098993          	addi	s3,s3,704 # 13b0 <malloc+0x120>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	56c90913          	addi	s2,s2,1388 # 1668 <malloc+0x3d8>
    ...
    if(what == 1){
     ...
     10e:	2b650513          	addi	a0,a0,694 # 13c0 <malloc+0x130>
    ...
    if(what == 1){
     ...
     168:	26c50513          	addi	a0,a0,620 # 13d0 <malloc+0x140>
     ...
     182:	24250513          	addi	a0,a0,578 # 13c0 <malloc+0x130>
     ...
     194:	1f050513          	addi	a0,a0,496 # 1380 <malloc+0xf0>
     ...
     1a6:	24650513          	addi	a0,a0,582 # 13e8 <malloc+0x158>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1f650513          	addi	a0,a0,502 # 13a8 <malloc+0x118>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	1c450513          	addi	a0,a0,452 # 1388 <malloc+0xf8>
     ...
     1f0:	20450513          	addi	a0,a0,516 # 13f0 <malloc+0x160>
     ...
     212:	1f250513          	addi	a0,a0,498 # 1400 <malloc+0x170>
     ...
     256:	16e50513          	addi	a0,a0,366 # 13c0 <malloc+0x130>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	1b250513          	addi	a0,a0,434 # 1418 <malloc+0x188>
     ...
     282:	1aa50513          	addi	a0,a0,426 # 1428 <malloc+0x198>
     ...
     294:	1a050513          	addi	a0,a0,416 # 1430 <malloc+0x1a0>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	19450513          	addi	a0,a0,404 # 1438 <malloc+0x1a8>
     ...
     2c0:	18c50513          	addi	a0,a0,396 # 1448 <malloc+0x1b8>
     ...
     2d2:	14250513          	addi	a0,a0,322 # 1410 <malloc+0x180>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	10a58593          	addi	a1,a1,266 # 13e8 <malloc+0x158>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	16a50513          	addi	a0,a0,362 # 1450 <malloc+0x1c0>
     ...
     2fc:	17050513          	addi	a0,a0,368 # 1468 <malloc+0x1d8>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	0e858593          	addi	a1,a1,232 # 13f0 <malloc+0x160>
     310:	00001517          	auipc	a0,0x1
     314:	16850513          	addi	a0,a0,360 # 1478 <malloc+0x1e8>
     ...
     348:	13c50513          	addi	a0,a0,316 # 1480 <malloc+0x1f0>
     ...
     396:	0ee50513          	addi	a0,a0,238 # 1480 <malloc+0x1f0>
     ...
     3a8:	a8a080e7          	jalr	-1398(ra) # e2e <exit>
      ...
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x53>
     ...
     3f6:	0a650513          	addi	a0,a0,166 # 1498 <malloc+0x208>
     ...
     422:	04250513          	addi	a0,a0,66 # 1460 <malloc+0x1d0>
     ...
     444:	04050513          	addi	a0,a0,64 # 1480 <malloc+0x1f0>
     ...
     45e:	04e50513          	addi	a0,a0,78 # 14a8 <malloc+0x218>
     ...
     4ac:	fd850513          	addi	a0,a0,-40 # 1480 <malloc+0x1f0>
     ...
     508:	fbc50513          	addi	a0,a0,-68 # 14c0 <malloc+0x230>
     ...
     534:	fa858593          	addi	a1,a1,-88 # 14d8 <malloc+0x248>
     ...
     636:	e4e50513          	addi	a0,a0,-434 # 1480 <malloc+0x1f0>
     ...
     650:	ed450513          	addi	a0,a0,-300 # 1520 <malloc+0x290>
     ...
     664:	ec050513          	addi	a0,a0,-320 # 1520 <malloc+0x290>
     ...
     67c:	e6058593          	addi	a1,a1,-416 # 14d8 <malloc+0x248>
     ...
     6c2:	e6250513          	addi	a0,a0,-414 # 1520 <malloc+0x290>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e5850513          	addi	a0,a0,-424 # 1528 <malloc+0x298>
     ...
     6ee:	e5650513          	addi	a0,a0,-426 # 1540 <malloc+0x2b0>
     ...
     708:	e5450513          	addi	a0,a0,-428 # 1558 <malloc+0x2c8>
     ...
     724:	e5050513          	addi	a0,a0,-432 # 1570 <malloc+0x2e0>
     ...
     73e:	e5e50513          	addi	a0,a0,-418 # 1598 <malloc+0x308>
     ...
     826:	e1658593          	addi	a1,a1,-490 # 1638 <malloc+0x3a8>
     ...
     84a:	dfa50513          	addi	a0,a0,-518 # 1640 <malloc+0x3b0>
     ...
     864:	c6058593          	addi	a1,a1,-928 # 14c0 <malloc+0x230>
     868:	4509                	li	a0,2
     ...
     880:	c4458593          	addi	a1,a1,-956 # 14c0 <malloc+0x230>
     884:	4509                	li	a0,2
     ...
     8dc:	ce858593          	addi	a1,a1,-792 # 15c0 <malloc+0x330>
     8e0:	4509                	li	a0,2
     ...
     950:	b3458593          	addi	a1,a1,-1228 # 1480 <malloc+0x1f0>
     954:	4509                	li	a0,2
     ...
     99c:	c2858593          	addi	a1,a1,-984 # 15c0 <malloc+0x330>
     9a0:	4509                	li	a0,2
     ...
     9e0:	be458593          	addi	a1,a1,-1052 # 15c0 <malloc+0x330>
     9e4:	4509                	li	a0,2
     ...
     a48:	a3c58593          	addi	a1,a1,-1476 # 1480 <malloc+0x1f0>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9f450513          	addi	a0,a0,-1548 # 1460 <malloc+0x1d0>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	99450513          	addi	a0,a0,-1644 # 1410 <malloc+0x180>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	9ca50513          	addi	a0,a0,-1590 # 1480 <malloc+0x1f0>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     ae8:	629c                	ld	a5,0(a3)
     aea:	6709                	lui	a4,0x2
     aec:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x4e1>
    ...
    printf("grind: fork failed\n");
     ...
     b02:	98250513          	addi	a0,a0,-1662 # 1480 <malloc+0x1f0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f46:	7e650513          	addi	a0,a0,2022 # 1728 <digits>
     f4a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1006:	6cec8c93          	addi	s9,s9,1742 # 16d0 <malloc+0x440>
  ...
  putc(fd, 'x');
    ...
    1014:	718b8b93          	addi	s7,s7,1816 # 1728 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    113a:	59298993          	addi	s3,s3,1426 # 16c8 <malloc+0x438>
        while(*s != 0){
    113e:	85ee                	mv	a1,s11
