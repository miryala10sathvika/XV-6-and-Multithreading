...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d10a0a13          	addi	s4,s4,-752 # 6260 <malloc+0x23e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c6c50513          	addi	a0,a0,-916 # 6268 <malloc+0x246>
     604:	00006097          	auipc	ra,0x6
     608:	966080e7          	jalr	-1690(ra) # 5f6a <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c6650513          	addi	a0,a0,-922 # 6280 <malloc+0x25e>
     622:	00006097          	auipc	ra,0x6
     626:	948080e7          	jalr	-1720(ra) # 5f6a <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c7850513          	addi	a0,a0,-904 # 62b0 <malloc+0x28e>
     640:	00006097          	auipc	ra,0x6
     644:	92a080e7          	jalr	-1750(ra) # 5f6a <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c8e50513          	addi	a0,a0,-882 # 62e0 <malloc+0x2be>
     65a:	00006097          	auipc	ra,0x6
     65e:	910080e7          	jalr	-1776(ra) # 5f6a <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c8050513          	addi	a0,a0,-896 # 62f0 <malloc+0x2ce>
     678:	00006097          	auipc	ra,0x6
     67c:	8f2080e7          	jalr	-1806(ra) # 5f6a <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c72a0a13          	addi	s4,s4,-910 # 6320 <malloc+0x2fe>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b02a8a93          	addi	s5,s5,-1278 # 61b8 <malloc+0x196>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bcc50513          	addi	a0,a0,-1076 # 6328 <malloc+0x306>
     764:	00006097          	auipc	ra,0x6
     768:	806080e7          	jalr	-2042(ra) # 5f6a <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	bc650513          	addi	a0,a0,-1082 # 6340 <malloc+0x31e>
     782:	00005097          	auipc	ra,0x5
     786:	7e8080e7          	jalr	2024(ra) # 5f6a <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	b4c50513          	addi	a0,a0,-1204 # 62e0 <malloc+0x2be>
     79c:	00005097          	auipc	ra,0x5
     7a0:	7ce080e7          	jalr	1998(ra) # 5f6a <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	bc250513          	addi	a0,a0,-1086 # 6370 <malloc+0x34e>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	7b4080e7          	jalr	1972(ra) # 5f6a <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	bbc50513          	addi	a0,a0,-1092 # 6388 <malloc+0x366>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	796080e7          	jalr	1942(ra) # 5f6a <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	98e58593          	addi	a1,a1,-1650 # 61b0 <malloc+0x18e>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	96250513          	addi	a0,a0,-1694 # 61a0 <malloc+0x17e>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	93650513          	addi	a0,a0,-1738 # 61a0 <malloc+0x17e>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	92250513          	addi	a0,a0,-1758 # 61a0 <malloc+0x17e>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b5c58593          	addi	a1,a1,-1188 # 6418 <malloc+0x3f6>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8a250513          	addi	a0,a0,-1886 # 61a0 <malloc+0x17e>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a7650513          	addi	a0,a0,-1418 # 63b8 <malloc+0x396>
     94a:	00005097          	auipc	ra,0x5
     94e:	620080e7          	jalr	1568(ra) # 5f6a <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a7a50513          	addi	a0,a0,-1414 # 63d8 <malloc+0x3b6>
     966:	00005097          	auipc	ra,0x5
     96a:	604080e7          	jalr	1540(ra) # 5f6a <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a7650513          	addi	a0,a0,-1418 # 63e8 <malloc+0x3c6>
     97a:	00005097          	auipc	ra,0x5
     97e:	5f0080e7          	jalr	1520(ra) # 5f6a <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a7a50513          	addi	a0,a0,-1414 # 6408 <malloc+0x3e6>
     996:	00005097          	auipc	ra,0x5
     99a:	5d4080e7          	jalr	1492(ra) # 5f6a <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	a4650513          	addi	a0,a0,-1466 # 63e8 <malloc+0x3c6>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	5c0080e7          	jalr	1472(ra) # 5f6a <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a6050513          	addi	a0,a0,-1440 # 6420 <malloc+0x3fe>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	5a2080e7          	jalr	1442(ra) # 5f6a <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a6250513          	addi	a0,a0,-1438 # 6440 <malloc+0x41e>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	584080e7          	jalr	1412(ra) # 5f6a <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a4e50513          	addi	a0,a0,-1458 # 6460 <malloc+0x43e>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a5e98993          	addi	s3,s3,-1442 # 6488 <malloc+0x466>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a8ea8a93          	addi	s5,s5,-1394 # 64c0 <malloc+0x49e>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9e850513          	addi	a0,a0,-1560 # 6460 <malloc+0x43e>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9ac50513          	addi	a0,a0,-1620 # 6460 <malloc+0x43e>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	98a50513          	addi	a0,a0,-1654 # 6468 <malloc+0x446>
     ae6:	00005097          	auipc	ra,0x5
     aea:	484080e7          	jalr	1156(ra) # 5f6a <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	99c50513          	addi	a0,a0,-1636 # 6498 <malloc+0x476>
     b04:	00005097          	auipc	ra,0x5
     b08:	466080e7          	jalr	1126(ra) # 5f6a <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	9b650513          	addi	a0,a0,-1610 # 64d0 <malloc+0x4ae>
     b22:	00005097          	auipc	ra,0x5
     b26:	448080e7          	jalr	1096(ra) # 5f6a <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9c250513          	addi	a0,a0,-1598 # 64f8 <malloc+0x4d6>
     b3e:	00005097          	auipc	ra,0x5
     b42:	42c080e7          	jalr	1068(ra) # 5f6a <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9c650513          	addi	a0,a0,-1594 # 6518 <malloc+0x4f6>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	410080e7          	jalr	1040(ra) # 5f6a <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9c250513          	addi	a0,a0,-1598 # 6530 <malloc+0x50e>
     b76:	00005097          	auipc	ra,0x5
     b7a:	3f4080e7          	jalr	1012(ra) # 5f6a <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9b050513          	addi	a0,a0,-1616 # 6550 <malloc+0x52e>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	95e50513          	addi	a0,a0,-1698 # 6550 <malloc+0x52e>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	91e50513          	addi	a0,a0,-1762 # 6558 <malloc+0x536>
     c42:	00005097          	auipc	ra,0x5
     c46:	328080e7          	jalr	808(ra) # 5f6a <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	92050513          	addi	a0,a0,-1760 # 6578 <malloc+0x556>
     c60:	00005097          	auipc	ra,0x5
     c64:	30a080e7          	jalr	778(ra) # 5f6a <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	92c50513          	addi	a0,a0,-1748 # 65a0 <malloc+0x57e>
     c7c:	00005097          	auipc	ra,0x5
     c80:	2ee080e7          	jalr	750(ra) # 5f6a <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8b050513          	addi	a0,a0,-1872 # 6550 <malloc+0x52e>
     ...
     cd0:	8f450513          	addi	a0,a0,-1804 # 65c0 <malloc+0x59e>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	296080e7          	jalr	662(ra) # 5f6a <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	8fe50513          	addi	a0,a0,-1794 # 65e8 <malloc+0x5c6>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	278080e7          	jalr	632(ra) # 5f6a <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	8f850513          	addi	a0,a0,-1800 # 6600 <malloc+0x5de>
     d10:	00005097          	auipc	ra,0x5
     d14:	25a080e7          	jalr	602(ra) # 5f6a <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	90450513          	addi	a0,a0,-1788 # 6628 <malloc+0x606>
     d2c:	00005097          	auipc	ra,0x5
     d30:	23e080e7          	jalr	574(ra) # 5f6a <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8ee50513          	addi	a0,a0,-1810 # 6640 <malloc+0x61e>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	90658593          	addi	a1,a1,-1786 # 6670 <malloc+0x64e>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ba50513          	addi	a0,a0,-1862 # 6640 <malloc+0x61e>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8a450513          	addi	a0,a0,-1884 # 6640 <malloc+0x61e>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	88e50513          	addi	a0,a0,-1906 # 6640 <malloc+0x61e>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	8f258593          	addi	a1,a1,-1806 # 66b8 <malloc+0x696>
  ...
  unlink("unlinkread");
     ...
     e32:	81250513          	addi	a0,a0,-2030 # 6640 <malloc+0x61e>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	80250513          	addi	a0,a0,-2046 # 6650 <malloc+0x62e>
     e56:	00005097          	auipc	ra,0x5
     e5a:	114080e7          	jalr	276(ra) # 5f6a <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	80e50513          	addi	a0,a0,-2034 # 6678 <malloc+0x656>
     e72:	00005097          	auipc	ra,0x5
     e76:	0f8080e7          	jalr	248(ra) # 5f6a <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	81250513          	addi	a0,a0,-2030 # 6698 <malloc+0x676>
     e8e:	00005097          	auipc	ra,0x5
     e92:	0dc080e7          	jalr	220(ra) # 5f6a <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	81e50513          	addi	a0,a0,-2018 # 66c0 <malloc+0x69e>
     eaa:	00005097          	auipc	ra,0x5
     eae:	0c0080e7          	jalr	192(ra) # 5f6a <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	82250513          	addi	a0,a0,-2014 # 66e0 <malloc+0x6be>
     ec6:	00005097          	auipc	ra,0x5
     eca:	0a4080e7          	jalr	164(ra) # 5f6a <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	82650513          	addi	a0,a0,-2010 # 6700 <malloc+0x6de>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	088080e7          	jalr	136(ra) # 5f6a <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	73258593          	addi	a1,a1,1842 # 6670 <malloc+0x64e>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7ca58593          	addi	a1,a1,1994 # 6728 <malloc+0x706>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ba50513          	addi	a0,a0,1978 # 6720 <malloc+0x6fe>
  ...
  unlink("lf1");
     ...
     f7e:	7a650513          	addi	a0,a0,1958 # 6720 <malloc+0x6fe>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	79450513          	addi	a0,a0,1940 # 6720 <malloc+0x6fe>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	78650513          	addi	a0,a0,1926 # 6728 <malloc+0x706>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	74e58593          	addi	a1,a1,1870 # 6728 <malloc+0x706>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	73850513          	addi	a0,a0,1848 # 6728 <malloc+0x706>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	72058593          	addi	a1,a1,1824 # 6720 <malloc+0x6fe>
    1008:	00005517          	auipc	a0,0x5
    100c:	72050513          	addi	a0,a0,1824 # 6728 <malloc+0x706>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	70458593          	addi	a1,a1,1796 # 6720 <malloc+0x6fe>
    1024:	00006517          	auipc	a0,0x6
    1028:	80c50513          	addi	a0,a0,-2036 # 6830 <malloc+0x80e>
    ...
    104a:	6ea50513          	addi	a0,a0,1770 # 6730 <malloc+0x70e>
    104e:	00005097          	auipc	ra,0x5
    1052:	f1c080e7          	jalr	-228(ra) # 5f6a <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	6e650513          	addi	a0,a0,1766 # 6748 <malloc+0x726>
    106a:	00005097          	auipc	ra,0x5
    106e:	f00080e7          	jalr	-256(ra) # 5f6a <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	6e250513          	addi	a0,a0,1762 # 6760 <malloc+0x73e>
    1086:	00005097          	auipc	ra,0x5
    108a:	ee4080e7          	jalr	-284(ra) # 5f6a <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	6e650513          	addi	a0,a0,1766 # 6780 <malloc+0x75e>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	ec8080e7          	jalr	-312(ra) # 5f6a <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	6fa50513          	addi	a0,a0,1786 # 67b0 <malloc+0x78e>
    10be:	00005097          	auipc	ra,0x5
    10c2:	eac080e7          	jalr	-340(ra) # 5f6a <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	6f650513          	addi	a0,a0,1782 # 67c8 <malloc+0x7a6>
    10da:	00005097          	auipc	ra,0x5
    10de:	e90080e7          	jalr	-368(ra) # 5f6a <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	6f250513          	addi	a0,a0,1778 # 67e0 <malloc+0x7be>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e74080e7          	jalr	-396(ra) # 5f6a <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	6fe50513          	addi	a0,a0,1790 # 6808 <malloc+0x7e6>
    1112:	00005097          	auipc	ra,0x5
    1116:	e58080e7          	jalr	-424(ra) # 5f6a <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	71250513          	addi	a0,a0,1810 # 6838 <malloc+0x816>
    112e:	00005097          	auipc	ra,0x5
    1132:	e3c080e7          	jalr	-452(ra) # 5f6a <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	70098993          	addi	s3,s3,1792 # 6858 <malloc+0x836>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	6d450513          	addi	a0,a0,1748 # 6868 <malloc+0x846>
    119c:	00005097          	auipc	ra,0x5
    11a0:	dce080e7          	jalr	-562(ra) # 5f6a <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	68ea0a13          	addi	s4,s4,1678 # 6888 <malloc+0x866>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	63c50513          	addi	a0,a0,1596 # 6888 <malloc+0x866>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	5d450513          	addi	a0,a0,1492 # 6890 <malloc+0x86e>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	ca6080e7          	jalr	-858(ra) # 5f6a <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	5d450513          	addi	a0,a0,1492 # 68b0 <malloc+0x88e>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	c86080e7          	jalr	-890(ra) # 5f6a <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	5d850513          	addi	a0,a0,1496 # 68d0 <malloc+0x8ae>
    1300:	00005097          	auipc	ra,0x5
    1304:	c6a080e7          	jalr	-918(ra) # 5f6a <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	de498993          	addi	s3,s3,-540 # 6148 <malloc+0x126>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	73a78793          	addi	a5,a5,1850 # 7b28 <malloc+0x1b06>
  ...
  if(pid == 0){
    ...
    144e:	11e78793          	addi	a5,a5,286 # 8568 <malloc+0x2546>
    ...
    1472:	cda50513          	addi	a0,a0,-806 # 6148 <malloc+0x126>
    ...
    148a:	4f250513          	addi	a0,a0,1266 # 6978 <malloc+0x956>
    148e:	00005097          	auipc	ra,0x5
    1492:	adc080e7          	jalr	-1316(ra) # 5f6a <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	44a50513          	addi	a0,a0,1098 # 68f0 <malloc+0x8ce>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	abc080e7          	jalr	-1348(ra) # 5f6a <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	44a50513          	addi	a0,a0,1098 # 6910 <malloc+0x8ee>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	a9c080e7          	jalr	-1380(ra) # 5f6a <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	44850513          	addi	a0,a0,1096 # 6930 <malloc+0x90e>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	a7a080e7          	jalr	-1414(ra) # 5f6a <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	45050513          	addi	a0,a0,1104 # 6958 <malloc+0x936>
    1510:	00005097          	auipc	ra,0x5
    1514:	a5a080e7          	jalr	-1446(ra) # 5f6a <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	8b650513          	addi	a0,a0,-1866 # 6dd8 <malloc+0xdb6>
    152a:	00005097          	auipc	ra,0x5
    152e:	a40080e7          	jalr	-1472(ra) # 5f6a <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	43450513          	addi	a0,a0,1076 # 69a0 <malloc+0x97e>
    1574:	00005097          	auipc	ra,0x5
    1578:	9f6080e7          	jalr	-1546(ra) # 5f6a <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	c0250513          	addi	a0,a0,-1022 # 61a0 <malloc+0x17e>
  ...
  if(pid == 0){
    ...
    15d4:	430a8a93          	addi	s5,s5,1072 # 6a00 <malloc+0x9de>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	39050513          	addi	a0,a0,912 # 69d0 <malloc+0x9ae>
    1648:	00005097          	auipc	ra,0x5
    164c:	922080e7          	jalr	-1758(ra) # 5f6a <printf>
    exit(1);
    1650:	4505                	li	a0,1
    ...
    1660:	38c50513          	addi	a0,a0,908 # 69e8 <malloc+0x9c6>
    1664:	00005097          	auipc	ra,0x5
    1668:	906080e7          	jalr	-1786(ra) # 5f6a <printf>
        exit(1);
    166c:	4505                	li	a0,1
    ...
    167e:	39650513          	addi	a0,a0,918 # 6a10 <malloc+0x9ee>
    1682:	00005097          	auipc	ra,0x5
    1686:	8e8080e7          	jalr	-1816(ra) # 5f6a <printf>
        exit(1);
    168a:	4505                	li	a0,1
    ...
    169c:	b08a0a13          	addi	s4,s4,-1272 # 61a0 <malloc+0x17e>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	390a8a93          	addi	s5,s5,912 # 6a30 <malloc+0xa0e>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	ab650513          	addi	a0,a0,-1354 # 61a0 <malloc+0x17e>
  ...
  exit(xstatus);
    ...
    170c:	2e050513          	addi	a0,a0,736 # 69e8 <malloc+0x9c6>
    1710:	00005097          	auipc	ra,0x5
    1714:	85a080e7          	jalr	-1958(ra) # 5f6a <printf>
      exit(1);
    1718:	4505                	li	a0,1
    ...
    172a:	31250513          	addi	a0,a0,786 # 6a38 <malloc+0xa16>
    172e:	00005097          	auipc	ra,0x5
    1732:	83c080e7          	jalr	-1988(ra) # 5f6a <printf>
      exit(1);
    1736:	4505                	li	a0,1
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	9fa78793          	addi	a5,a5,-1542 # 6148 <malloc+0x126>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	2fe78793          	addi	a5,a5,766 # 6a58 <malloc+0xa36>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2f650513          	addi	a0,a0,758 # 6a60 <malloc+0xa3e>
  ...
  if(pid == 0) {
    ...
    179c:	2c850513          	addi	a0,a0,712 # 6a60 <malloc+0xa3e>
    ...
    17b8:	2cc50513          	addi	a0,a0,716 # 6a80 <malloc+0xa5e>
    17bc:	00004097          	auipc	ra,0x4
    17c0:	7ae080e7          	jalr	1966(ra) # 5f6a <printf>
      exit(1);
    17c4:	4505                	li	a0,1
    ...
    17d4:	20050513          	addi	a0,a0,512 # 69d0 <malloc+0x9ae>
    17d8:	00004097          	auipc	ra,0x4
    17dc:	792080e7          	jalr	1938(ra) # 5f6a <printf>
     exit(1);
    17e0:	4505                	li	a0,1
    ...
    17f0:	27c50513          	addi	a0,a0,636 # 6a68 <malloc+0xa46>
    17f4:	00004097          	auipc	ra,0x4
    17f8:	776080e7          	jalr	1910(ra) # 5f6a <printf>
      exit(1);
    17fc:	4505                	li	a0,1
    ...
    180e:	93e50513          	addi	a0,a0,-1730 # 6148 <malloc+0x126>
  ...
  if(xstatus != 0)
    ...
    1842:	25250513          	addi	a0,a0,594 # 6a90 <malloc+0xa6e>
    1846:	00004097          	auipc	ra,0x4
    184a:	724080e7          	jalr	1828(ra) # 5f6a <printf>
      exit(1);
    184e:	4505                	li	a0,1
    ...
    185e:	24e50513          	addi	a0,a0,590 # 6aa8 <malloc+0xa86>
    1862:	00004097          	auipc	ra,0x4
    1866:	708080e7          	jalr	1800(ra) # 5f6a <printf>
    186a:	b7d1                	j	182e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186c:	4581                	li	a1,0
    186e:	00005517          	auipc	a0,0x5
    1872:	1f250513          	addi	a0,a0,498 # 6a60 <malloc+0xa3e>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c8050513          	addi	a0,a0,-896 # 6518 <malloc+0x4f6>
    18a0:	00004097          	auipc	ra,0x4
    18a4:	6ca080e7          	jalr	1738(ra) # 5f6a <printf>
    exit(1);
    18a8:	4505                	li	a0,1
    ...
    18b8:	13450513          	addi	a0,a0,308 # 69e8 <malloc+0x9c6>
    18bc:	00004097          	auipc	ra,0x4
    18c0:	6ae080e7          	jalr	1710(ra) # 5f6a <printf>
    exit(1);
    18c4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d2:	19250513          	addi	a0,a0,402 # 6a60 <malloc+0xa3e>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	1c850513          	addi	a0,a0,456 # 6ac0 <malloc+0xa9e>
    1900:	00004097          	auipc	ra,0x4
    1904:	66a080e7          	jalr	1642(ra) # 5f6a <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	12050513          	addi	a0,a0,288 # 6ad8 <malloc+0xab6>
    19c0:	00004097          	auipc	ra,0x4
    19c4:	5aa080e7          	jalr	1450(ra) # 5f6a <printf>
    exit(1);
    19c8:	4505                	li	a0,1
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	0b250513          	addi	a0,a0,178 # 6af0 <malloc+0xace>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	524080e7          	jalr	1316(ra) # 5f6a <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
    ...
    1a5e:	0ae50513          	addi	a0,a0,174 # 6b08 <malloc+0xae6>
    1a62:	00004097          	auipc	ra,0x4
    1a66:	508080e7          	jalr	1288(ra) # 5f6a <printf>
}
    ...
    1a90:	09450513          	addi	a0,a0,148 # 6b20 <malloc+0xafe>
    1a94:	00004097          	auipc	ra,0x4
    1a98:	4d6080e7          	jalr	1238(ra) # 5f6a <printf>
      exit(1);
    1a9c:	4505                	li	a0,1
    ...
    1ad0:	07450513          	addi	a0,a0,116 # 6b40 <malloc+0xb1e>
    1ad4:	00004097          	auipc	ra,0x4
    1ad8:	496080e7          	jalr	1174(ra) # 5f6a <printf>
    exit(1);
    1adc:	4505                	li	a0,1
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	e9250513          	addi	a0,a0,-366 # 69d0 <malloc+0x9ae>
    1b46:	00004097          	auipc	ra,0x4
    1b4a:	424080e7          	jalr	1060(ra) # 5f6a <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5e:	ffe50513          	addi	a0,a0,-2 # 6b58 <malloc+0xb36>
    1b62:	00004097          	auipc	ra,0x4
    1b66:	408080e7          	jalr	1032(ra) # 5f6a <printf>
        exit(1);
    1b6a:	4505                	li	a0,1
    ...
    1b7a:	ffa50513          	addi	a0,a0,-6 # 6b70 <malloc+0xb4e>
    1b7e:	00004097          	auipc	ra,0x4
    1b82:	3ec080e7          	jalr	1004(ra) # 5f6a <printf>
        exit(1);
    1b86:	4505                	li	a0,1
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	de250513          	addi	a0,a0,-542 # 69d0 <malloc+0x9ae>
    1bf6:	00004097          	auipc	ra,0x4
    1bfa:	374080e7          	jalr	884(ra) # 5f6a <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c16:	dbe50513          	addi	a0,a0,-578 # 69d0 <malloc+0x9ae>
    1c1a:	00004097          	auipc	ra,0x4
    1c1e:	350080e7          	jalr	848(ra) # 5f6a <printf>
        exit(1);
    1c22:	4505                	li	a0,1
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	f0450513          	addi	a0,a0,-252 # 6b90 <malloc+0xb6e>
    1c94:	00004097          	auipc	ra,0x4
    1c98:	2d6080e7          	jalr	726(ra) # 5f6a <printf>
      exit(1);
    1c9c:	4505                	li	a0,1
    ...
    1ca2:	f22080e7          	jalr	-222(ra) # 5bc0 <exit>
{
    ...
    1ce8:	ebc50513          	addi	a0,a0,-324 # 6ba0 <malloc+0xb7e>
    1cec:	00004097          	auipc	ra,0x4
    1cf0:	27e080e7          	jalr	638(ra) # 5f6a <printf>
      exit(1);
    1cf4:	4505                	li	a0,1
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	0a650513          	addi	a0,a0,166 # 6dd8 <malloc+0xdb6>
    1d3a:	00004097          	auipc	ra,0x4
    1d3e:	230080e7          	jalr	560(ra) # 5f6a <printf>
      exit(1);
    1d42:	4505                	li	a0,1
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	00850513          	addi	a0,a0,8 # 6dd8 <malloc+0xdb6>
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	192080e7          	jalr	402(ra) # 5f6a <printf>
      exit(1);
    1de0:	4505                	li	a0,1
    ...
    1e00:	c6c50513          	addi	a0,a0,-916 # 6a68 <malloc+0xa46>
    1e04:	00004097          	auipc	ra,0x4
    1e08:	166080e7          	jalr	358(ra) # 5f6a <printf>
          exit(1);
    1e0c:	4505                	li	a0,1
    ...
    1e72:	d5250513          	addi	a0,a0,-686 # 6bc0 <malloc+0xb9e>
    1e76:	00004097          	auipc	ra,0x4
    1e7a:	0f4080e7          	jalr	244(ra) # 5f6a <printf>
            exit(1);
    1e7e:	4505                	li	a0,1
    ...
    1ea6:	d3650513          	addi	a0,a0,-714 # 6bd8 <malloc+0xbb6>
    1eaa:	00004097          	auipc	ra,0x4
    1eae:	0c0080e7          	jalr	192(ra) # 5f6a <printf>
        exit(1);
    1eb2:	4505                	li	a0,1
    ...
    1f0c:	cf850513          	addi	a0,a0,-776 # 6c00 <malloc+0xbde>
    1f10:	00004097          	auipc	ra,0x4
    1f14:	05a080e7          	jalr	90(ra) # 5f6a <printf>
        exit(1);
    1f18:	4505                	li	a0,1
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	21050513          	addi	a0,a0,528 # 61b8 <malloc+0x196>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	1d4a8a93          	addi	s5,s5,468 # 61b8 <malloc+0x196>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c3cb8b93          	addi	s7,s7,-964 # 6c28 <malloc+0xc06>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	9d850513          	addi	a0,a0,-1576 # 69d0 <malloc+0x9ae>
    2000:	00004097          	auipc	ra,0x4
    2004:	f6a080e7          	jalr	-150(ra) # 5f6a <printf>
    exit(1);
    2008:	4505                	li	a0,1
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b8e50513          	addi	a0,a0,-1138 # 6c48 <malloc+0xc26>
    20c2:	00004097          	auipc	ra,0x4
    20c6:	ea8080e7          	jalr	-344(ra) # 5f6a <printf>
    exit(1);
    20ca:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2120:	b1450513          	addi	a0,a0,-1260 # 6c30 <malloc+0xc0e>
    2124:	00004097          	auipc	ra,0x4
    2128:	e46080e7          	jalr	-442(ra) # 5f6a <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	b3850513          	addi	a0,a0,-1224 # 6c70 <malloc+0xc4e>
    2140:	00004097          	auipc	ra,0x4
    2144:	e2a080e7          	jalr	-470(ra) # 5f6a <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	b3450513          	addi	a0,a0,-1228 # 6c88 <malloc+0xc66>
    215c:	00004097          	auipc	ra,0x4
    2160:	e0e080e7          	jalr	-498(ra) # 5f6a <printf>
    exit(1);
    2164:	4505                	li	a0,1
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	7fc50513          	addi	a0,a0,2044 # 69d0 <malloc+0x9ae>
    ...
    21fa:	aaa50513          	addi	a0,a0,-1366 # 6ca0 <malloc+0xc7e>
    21fe:	00004097          	auipc	ra,0x4
    2202:	d6c080e7          	jalr	-660(ra) # 5f6a <printf>
      exit(1);
    2206:	4505                	li	a0,1
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	75850513          	addi	a0,a0,1880 # 69d0 <malloc+0x9ae>
    2280:	00004097          	auipc	ra,0x4
    2284:	cea080e7          	jalr	-790(ra) # 5f6a <printf>
      exit(1);
    2288:	4505                	li	a0,1
    ...
    22a8:	a1c50513          	addi	a0,a0,-1508 # 6cc0 <malloc+0xc9e>
    22ac:	00004097          	auipc	ra,0x4
    22b0:	cbe080e7          	jalr	-834(ra) # 5f6a <printf>
      exit(1);
    22b4:	4505                	li	a0,1
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	a0450513          	addi	a0,a0,-1532 # 6cd8 <malloc+0xcb6>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	9d250513          	addi	a0,a0,-1582 # 6cd8 <malloc+0xcb6>
  ...
  close(fd);
    ...
    2340:	9ac70713          	addi	a4,a4,-1620 # 6ce8 <malloc+0xcc6>
    ...
    2394:	a3850513          	addi	a0,a0,-1480 # 6dc8 <malloc+0xda6>
    2398:	00004097          	auipc	ra,0x4
    239c:	bd2080e7          	jalr	-1070(ra) # 5f6a <printf>
    exit(1);
    23a0:	4505                	li	a0,1
    ...
    23b8:	a3450513          	addi	a0,a0,-1484 # 6de8 <malloc+0xdc6>
    23bc:	00004097          	auipc	ra,0x4
    23c0:	bae080e7          	jalr	-1106(ra) # 5f6a <printf>
    exit(1);
    23c4:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	9f650513          	addi	a0,a0,-1546 # 6e08 <malloc+0xde6>
    241a:	00004097          	auipc	ra,0x4
    241e:	b50080e7          	jalr	-1200(ra) # 5f6a <printf>
    exit(1);
    2422:	4505                	li	a0,1
    ...
    2432:	5a250513          	addi	a0,a0,1442 # 69d0 <malloc+0x9ae>
    2436:	00004097          	auipc	ra,0x4
    243a:	b34080e7          	jalr	-1228(ra) # 5f6a <printf>
    exit(1);
    243e:	4505                	li	a0,1
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1){  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	53450513          	addi	a0,a0,1332 # 69d0 <malloc+0x9ae>
    24a4:	00004097          	auipc	ra,0x4
    24a8:	ac6080e7          	jalr	-1338(ra) # 5f6a <printf>
    exit(1);
    24ac:	4505                	li	a0,1
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	8c050513          	addi	a0,a0,-1856 # 6dd8 <malloc+0xdb6>
    2520:	00004097          	auipc	ra,0x4
    2524:	a4a080e7          	jalr	-1462(ra) # 5f6a <printf>
      exit(1);
    2528:	4505                	li	a0,1
    ...
    25cc:	86850513          	addi	a0,a0,-1944 # 6e30 <malloc+0xe0e>
    25d0:	00004097          	auipc	ra,0x4
    25d4:	99a080e7          	jalr	-1638(ra) # 5f6a <printf>
            exit(1);
    25d8:	4505                	li	a0,1
    ...
    25ec:	c3050513          	addi	a0,a0,-976 # 6218 <malloc+0x1f6>
    25f0:	00004097          	auipc	ra,0x4
    25f4:	97a080e7          	jalr	-1670(ra) # 5f6a <printf>
            exit(1);
    25f8:	4505                	li	a0,1
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	4a878793          	addi	a5,a5,1192 # 7b28 <malloc+0x1b06>
  ...
  if(ret != -1){
    ...
    26c6:	78650513          	addi	a0,a0,1926 # 6e48 <malloc+0xe26>
    26ca:	00004097          	auipc	ra,0x4
    26ce:	8a0080e7          	jalr	-1888(ra) # 5f6a <printf>
    exit(1);
    26d2:	4505                	li	a0,1
    ...
    26e4:	21050513          	addi	a0,a0,528 # 68f0 <malloc+0x8ce>
    26e8:	00004097          	auipc	ra,0x4
    26ec:	882080e7          	jalr	-1918(ra) # 5f6a <printf>
    exit(1);
    26f0:	4505                	li	a0,1
    ...
    2702:	21250513          	addi	a0,a0,530 # 6910 <malloc+0x8ee>
    2706:	00004097          	auipc	ra,0x4
    270a:	864080e7          	jalr	-1948(ra) # 5f6a <printf>
    exit(1);
    270e:	4505                	li	a0,1
    ...
    2722:	21250513          	addi	a0,a0,530 # 6930 <malloc+0x90e>
    2726:	00004097          	auipc	ra,0x4
    272a:	844080e7          	jalr	-1980(ra) # 5f6a <printf>
    exit(1);
    272e:	4505                	li	a0,1
    ...
    2740:	21c50513          	addi	a0,a0,540 # 6958 <malloc+0x936>
    2744:	00004097          	auipc	ra,0x4
    2748:	826080e7          	jalr	-2010(ra) # 5f6a <printf>
    exit(1);
    274c:	4505                	li	a0,1
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	70050513          	addi	a0,a0,1792 # 6e88 <malloc+0xe66>
  ...
  if(n >= 0){
    ...
    27bc:	6f050513          	addi	a0,a0,1776 # 6ea8 <malloc+0xe86>
    27c0:	00003097          	auipc	ra,0x3
    27c4:	7aa080e7          	jalr	1962(ra) # 5f6a <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d6:	67e50513          	addi	a0,a0,1662 # 6e50 <malloc+0xe2e>
    27da:	00003097          	auipc	ra,0x3
    27de:	790080e7          	jalr	1936(ra) # 5f6a <printf>
    exit(1);
    27e2:	4505                	li	a0,1
    ...
    27f0:	67c50513          	addi	a0,a0,1660 # 6e68 <malloc+0xe46>
    27f4:	00003097          	auipc	ra,0x3
    27f8:	776080e7          	jalr	1910(ra) # 5f6a <printf>
    exit(1);
    27fc:	4505                	li	a0,1
    ...
    280a:	68a50513          	addi	a0,a0,1674 # 6e90 <malloc+0xe6e>
    280e:	00003097          	auipc	ra,0x3
    2812:	75c080e7          	jalr	1884(ra) # 5f6a <printf>
    exit(1);
    2816:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    282e:	65e50513          	addi	a0,a0,1630 # 6e88 <malloc+0xe66>
    2832:	00003097          	auipc	ra,0x3
    2836:	3de080e7          	jalr	990(ra) # 5c10 <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	ae450513          	addi	a0,a0,-1308 # 6320 <malloc+0x2fe>
  ...
  if(n >= 0){
    ...
    286a:	67250513          	addi	a0,a0,1650 # 6ed8 <malloc+0xeb6>
    286e:	00003097          	auipc	ra,0x3
    2872:	6fc080e7          	jalr	1788(ra) # 5f6a <printf>
    exit(1);
    2876:	4505                	li	a0,1
    ...
    2884:	61050513          	addi	a0,a0,1552 # 6e90 <malloc+0xe6e>
    2888:	00003097          	auipc	ra,0x3
    288c:	6e2080e7          	jalr	1762(ra) # 5f6a <printf>
    exit(1);
    2890:	4505                	li	a0,1
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	60050513          	addi	a0,a0,1536 # 6f00 <malloc+0xede>
    2908:	00003097          	auipc	ra,0x3
    290c:	662080e7          	jalr	1634(ra) # 5f6a <printf>
    exit(1);
    2910:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	5ce50513          	addi	a0,a0,1486 # 6f20 <malloc+0xefe>
    295a:	00003097          	auipc	ra,0x3
    295e:	610080e7          	jalr	1552(ra) # 5f6a <printf>
    exit(1);
    2962:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29ba:	5ca50513          	addi	a0,a0,1482 # 6f80 <malloc+0xf5e>
    29be:	00003097          	auipc	ra,0x3
    29c2:	5ac080e7          	jalr	1452(ra) # 5f6a <printf>
    exit(1);
    29c6:	4505                	li	a0,1
    ...
    29dc:	56850513          	addi	a0,a0,1384 # 6f40 <malloc+0xf1e>
    29e0:	00003097          	auipc	ra,0x3
    29e4:	58a080e7          	jalr	1418(ra) # 5f6a <printf>
      exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f8:	56c50513          	addi	a0,a0,1388 # 6f60 <malloc+0xf3e>
    29fc:	00003097          	auipc	ra,0x3
    2a00:	56e080e7          	jalr	1390(ra) # 5f6a <printf>
    exit(1);
    2a04:	4505                	li	a0,1
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	46250513          	addi	a0,a0,1122 # 6fa0 <malloc+0xf7e>
    2b46:	00003097          	auipc	ra,0x3
    2b4a:	424080e7          	jalr	1060(ra) # 5f6a <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5e:	48e50513          	addi	a0,a0,1166 # 6fe8 <malloc+0xfc6>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	408080e7          	jalr	1032(ra) # 5f6a <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7e:	48e50513          	addi	a0,a0,1166 # 7008 <malloc+0xfe6>
    2b82:	00003097          	auipc	ra,0x3
    2b86:	3e8080e7          	jalr	1000(ra) # 5f6a <printf>
    exit(1);
    2b8a:	4505                	li	a0,1
    ...
    2b9e:	4ae50513          	addi	a0,a0,1198 # 7048 <malloc+0x1026>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	3c8080e7          	jalr	968(ra) # 5f6a <printf>
    exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bba:	4c250513          	addi	a0,a0,1218 # 7078 <malloc+0x1056>
    2bbe:	00003097          	auipc	ra,0x3
    2bc2:	3ac080e7          	jalr	940(ra) # 5f6a <printf>
    exit(1);
    2bc6:	4505                	li	a0,1
    ...
    2bda:	4da50513          	addi	a0,a0,1242 # 70b0 <malloc+0x108e>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	38c080e7          	jalr	908(ra) # 5f6a <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	4c850513          	addi	a0,a0,1224 # 70d8 <malloc+0x10b6>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	4b650513          	addi	a0,a0,1206 # 70d8 <malloc+0x10b6>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	46a50513          	addi	a0,a0,1130 # 70e0 <malloc+0x10be>
    2c7e:	00003097          	auipc	ra,0x3
    2c82:	2ec080e7          	jalr	748(ra) # 5f6a <printf>
    exit(1);
    2c86:	4505                	li	a0,1
    ...
    2c96:	46650513          	addi	a0,a0,1126 # 70f8 <malloc+0x10d6>
    2c9a:	00003097          	auipc	ra,0x3
    2c9e:	2d0080e7          	jalr	720(ra) # 5f6a <printf>
    exit(1);
    2ca2:	4505                	li	a0,1
    ...
    2cb2:	e2a50513          	addi	a0,a0,-470 # 6ad8 <malloc+0xab6>
    2cb6:	00003097          	auipc	ra,0x3
    2cba:	2b4080e7          	jalr	692(ra) # 5f6a <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	43850513          	addi	a0,a0,1080 # 7110 <malloc+0x10ee>
  ...
  close(fd);
    ...
    2d24:	cc850513          	addi	a0,a0,-824 # 69e8 <malloc+0x9c6>
    2d28:	00003097          	auipc	ra,0x3
    2d2c:	242080e7          	jalr	578(ra) # 5f6a <printf>
    exit(1);
    2d30:	4505                	li	a0,1
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	06a50513          	addi	a0,a0,106 # 6dd8 <malloc+0xdb6>
    2d76:	00003097          	auipc	ra,0x3
    2d7a:	1f4080e7          	jalr	500(ra) # 5f6a <printf>
    exit(1);
    2d7e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dc8:	01450513          	addi	a0,a0,20 # 6dd8 <malloc+0xdb6>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	19e080e7          	jalr	414(ra) # 5f6a <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e28:	fb450513          	addi	a0,a0,-76 # 6dd8 <malloc+0xdb6>
    2e2c:	00003097          	auipc	ra,0x3
    2e30:	13e080e7          	jalr	318(ra) # 5f6a <printf>
    exit(1);
    2e34:	4505                	li	a0,1
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e4050513          	addi	a0,a0,-448 # 6dd8 <malloc+0xdb6>
    2fa0:	00003097          	auipc	ra,0x3
    2fa4:	fca080e7          	jalr	-54(ra) # 5f6a <printf>
      exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2ff0:	15c50513          	addi	a0,a0,348 # 6148 <malloc+0x126>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	1c078793          	addi	a5,a5,448 # 61b8 <malloc+0x196>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	2be50513          	addi	a0,a0,702 # 72e8 <malloc+0x12c6>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	10450513          	addi	a0,a0,260 # 7140 <malloc+0x111e>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	14650513          	addi	a0,a0,326 # 7198 <malloc+0x1176>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	1a050513          	addi	a0,a0,416 # 7210 <malloc+0x11ee>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	1f450513          	addi	a0,a0,500 # 7280 <malloc+0x125e>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	23a50513          	addi	a0,a0,570 # 72d8 <malloc+0x12b6>
  ...
  unlink("12345678901234");
    ...
    3120:	ffc50513          	addi	a0,a0,-4 # 7118 <malloc+0x10f6>
    3124:	00003097          	auipc	ra,0x3
    3128:	e46080e7          	jalr	-442(ra) # 5f6a <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	02850513          	addi	a0,a0,40 # 7160 <malloc+0x113e>
    3140:	00003097          	auipc	ra,0x3
    3144:	e2a080e7          	jalr	-470(ra) # 5f6a <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	07450513          	addi	a0,a0,116 # 71c8 <malloc+0x11a6>
    315c:	00003097          	auipc	ra,0x3
    3160:	e0e080e7          	jalr	-498(ra) # 5f6a <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	0d050513          	addi	a0,a0,208 # 7240 <malloc+0x121e>
    3178:	00003097          	auipc	ra,0x3
    317c:	df2080e7          	jalr	-526(ra) # 5f6a <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	11450513          	addi	a0,a0,276 # 72a0 <malloc+0x127e>
    3194:	00003097          	auipc	ra,0x3
    3198:	dd6080e7          	jalr	-554(ra) # 5f6a <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	15050513          	addi	a0,a0,336 # 72f8 <malloc+0x12d6>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	dba080e7          	jalr	-582(ra) # 5f6a <printf>
    exit(1);
    31b8:	4505                	li	a0,1
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	13c50513          	addi	a0,a0,316 # 7330 <malloc+0x130e>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	12250513          	addi	a0,a0,290 # 7340 <malloc+0x131e>
    3226:	00003097          	auipc	ra,0x3
    322a:	d44080e7          	jalr	-700(ra) # 5f6a <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	08250513          	addi	a0,a0,130 # 7330 <malloc+0x130e>
  ...
  unlink("diskfulldir");
    ...
    32c6:	06e50513          	addi	a0,a0,110 # 7330 <malloc+0x130e>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f7050513          	addi	a0,a0,-144 # 7360 <malloc+0x133e>
    33f8:	00003097          	auipc	ra,0x3
    33fc:	b72080e7          	jalr	-1166(ra) # 5f6a <printf>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f8250513          	addi	a0,a0,-126 # 7390 <malloc+0x136e>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f6e50513          	addi	a0,a0,-146 # 7390 <malloc+0x136e>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	f9a50513          	addi	a0,a0,-102 # 73d0 <malloc+0x13ae>
  ...
  if(chdir("/") < 0){
    ...
    344e:	fb650513          	addi	a0,a0,-74 # 7400 <malloc+0x13de>
    ...
    346e:	f2e50513          	addi	a0,a0,-210 # 7398 <malloc+0x1376>
    3472:	00003097          	auipc	ra,0x3
    3476:	af8080e7          	jalr	-1288(ra) # 5f6a <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	f2a50513          	addi	a0,a0,-214 # 73b0 <malloc+0x138e>
    348e:	00003097          	auipc	ra,0x3
    3492:	adc080e7          	jalr	-1316(ra) # 5f6a <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	f3e50513          	addi	a0,a0,-194 # 73e0 <malloc+0x13be>
    34aa:	00003097          	auipc	ra,0x3
    34ae:	ac0080e7          	jalr	-1344(ra) # 5f6a <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	f4a50513          	addi	a0,a0,-182 # 7408 <malloc+0x13e6>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	aa4080e7          	jalr	-1372(ra) # 5f6a <printf>
    exit(1);
    34ce:	4505                	li	a0,1
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	e9e50513          	addi	a0,a0,-354 # 7390 <malloc+0x136e>
    ...
    350a:	e8a50513          	addi	a0,a0,-374 # 7390 <malloc+0x136e>
    ...
    351e:	eb650513          	addi	a0,a0,-330 # 73d0 <malloc+0x13ae>
    ...
    353e:	49650513          	addi	a0,a0,1174 # 69d0 <malloc+0x9ae>
    3542:	00003097          	auipc	ra,0x3
    3546:	a28080e7          	jalr	-1496(ra) # 5f6a <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	e4250513          	addi	a0,a0,-446 # 7398 <malloc+0x1376>
    355e:	00003097          	auipc	ra,0x3
    3562:	a0c080e7          	jalr	-1524(ra) # 5f6a <printf>
      exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	eae50513          	addi	a0,a0,-338 # 7420 <malloc+0x13fe>
    357a:	00003097          	auipc	ra,0x3
    357e:	9f0080e7          	jalr	-1552(ra) # 5f6a <printf>
      exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	e5250513          	addi	a0,a0,-430 # 73e0 <malloc+0x13be>
    3596:	00003097          	auipc	ra,0x3
    359a:	9d4080e7          	jalr	-1580(ra) # 5f6a <printf>
      exit(1);
    359e:	4505                	li	a0,1
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e6c50513          	addi	a0,a0,-404 # 7438 <malloc+0x1416>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e5850513          	addi	a0,a0,-424 # 7438 <malloc+0x1416>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e6450513          	addi	a0,a0,-412 # 7458 <malloc+0x1436>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e3050513          	addi	a0,a0,-464 # 7438 <malloc+0x1416>
    ...
    362c:	d7050513          	addi	a0,a0,-656 # 7398 <malloc+0x1376>
    3630:	00003097          	auipc	ra,0x3
    3634:	93a080e7          	jalr	-1734(ra) # 5f6a <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	dfc50513          	addi	a0,a0,-516 # 7440 <malloc+0x141e>
    364c:	00003097          	auipc	ra,0x3
    3650:	91e080e7          	jalr	-1762(ra) # 5f6a <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	e0050513          	addi	a0,a0,-512 # 7460 <malloc+0x143e>
    3668:	00003097          	auipc	ra,0x3
    366c:	902080e7          	jalr	-1790(ra) # 5f6a <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	dfc50513          	addi	a0,a0,-516 # 7478 <malloc+0x1456>
    3684:	00003097          	auipc	ra,0x3
    3688:	8e6080e7          	jalr	-1818(ra) # 5f6a <printf>
    exit(1);
    368c:	4505                	li	a0,1
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f1c50513          	addi	a0,a0,-228 # 75c0 <malloc+0x159e>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	ddc50513          	addi	a0,a0,-548 # 7490 <malloc+0x146e>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	de450513          	addi	a0,a0,-540 # 74b0 <malloc+0x148e>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	edc58593          	addi	a1,a1,-292 # 75c0 <malloc+0x159e>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	d9250513          	addi	a0,a0,-622 # 7490 <malloc+0x146e>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	df650513          	addi	a0,a0,-522 # 7508 <malloc+0x14e6>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	e0650513          	addi	a0,a0,-506 # 7530 <malloc+0x150e>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e1e58593          	addi	a1,a1,-482 # 7560 <malloc+0x153e>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	e0a50513          	addi	a0,a0,-502 # 7568 <malloc+0x1546>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e1258593          	addi	a1,a1,-494 # 75b8 <malloc+0x1596>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d8250513          	addi	a0,a0,-638 # 7530 <malloc+0x150e>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d6e50513          	addi	a0,a0,-658 # 7530 <malloc+0x150e>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d5850513          	addi	a0,a0,-680 # 7530 <malloc+0x150e>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	ca450513          	addi	a0,a0,-860 # 7490 <malloc+0x146e>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e5050513          	addi	a0,a0,-432 # 7650 <malloc+0x162e>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e6c50513          	addi	a0,a0,-404 # 7680 <malloc+0x165e>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e8850513          	addi	a0,a0,-376 # 76b0 <malloc+0x168e>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	cb850513          	addi	a0,a0,-840 # 7530 <malloc+0x150e>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	eb050513          	addi	a0,a0,-336 # 7740 <malloc+0x171e>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	ec850513          	addi	a0,a0,-312 # 7770 <malloc+0x174e>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	bd050513          	addi	a0,a0,-1072 # 7490 <malloc+0x146e>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	bba50513          	addi	a0,a0,-1094 # 7490 <malloc+0x146e>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	ba450513          	addi	a0,a0,-1116 # 7490 <malloc+0x146e>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	f0058593          	addi	a1,a1,-256 # 7800 <malloc+0x17de>
    3908:	00004517          	auipc	a0,0x4
    390c:	e3850513          	addi	a0,a0,-456 # 7740 <malloc+0x171e>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	ee458593          	addi	a1,a1,-284 # 7800 <malloc+0x17de>
    3924:	00004517          	auipc	a0,0x4
    3928:	e4c50513          	addi	a0,a0,-436 # 7770 <malloc+0x174e>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c8058593          	addi	a1,a1,-896 # 75b8 <malloc+0x1596>
    3940:	00004517          	auipc	a0,0x4
    3944:	b7050513          	addi	a0,a0,-1168 # 74b0 <malloc+0x148e>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	dec50513          	addi	a0,a0,-532 # 7740 <malloc+0x171e>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	e0850513          	addi	a0,a0,-504 # 7770 <malloc+0x174e>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c3c50513          	addi	a0,a0,-964 # 75b8 <malloc+0x1596>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	de050513          	addi	a0,a0,-544 # 7770 <malloc+0x174e>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	d9c50513          	addi	a0,a0,-612 # 7740 <malloc+0x171e>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	af850513          	addi	a0,a0,-1288 # 74b0 <malloc+0x148e>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f8450513          	addi	a0,a0,-124 # 7950 <malloc+0x192e>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	bd850513          	addi	a0,a0,-1064 # 75b8 <malloc+0x1596>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	abc50513          	addi	a0,a0,-1348 # 74b0 <malloc+0x148e>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a8850513          	addi	a0,a0,-1400 # 7490 <malloc+0x146e>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	fa450513          	addi	a0,a0,-92 # 79c0 <malloc+0x199e>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a6050513          	addi	a0,a0,-1440 # 7490 <malloc+0x146e>
    ...
    3a56:	a4650513          	addi	a0,a0,-1466 # 7498 <malloc+0x1476>
    3a5a:	00002097          	auipc	ra,0x2
    3a5e:	510080e7          	jalr	1296(ra) # 5f6a <printf>
    exit(1);
    3a62:	4505                	li	a0,1
    ...
    3a72:	a4a50513          	addi	a0,a0,-1462 # 74b8 <malloc+0x1496>
    3a76:	00002097          	auipc	ra,0x2
    3a7a:	4f4080e7          	jalr	1268(ra) # 5f6a <printf>
    exit(1);
    3a7e:	4505                	li	a0,1
    ...
    3a8e:	a4e50513          	addi	a0,a0,-1458 # 74d8 <malloc+0x14b6>
    3a92:	00002097          	auipc	ra,0x2
    3a96:	4d8080e7          	jalr	1240(ra) # 5f6a <printf>
    exit(1);
    3a9a:	4505                	li	a0,1
    ...
    3aaa:	a6a50513          	addi	a0,a0,-1430 # 7510 <malloc+0x14ee>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	4bc080e7          	jalr	1212(ra) # 5f6a <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a7e50513          	addi	a0,a0,-1410 # 7540 <malloc+0x151e>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	4a0080e7          	jalr	1184(ra) # 5f6a <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a9a50513          	addi	a0,a0,-1382 # 7578 <malloc+0x1556>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	484080e7          	jalr	1156(ra) # 5f6a <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a9e50513          	addi	a0,a0,-1378 # 7598 <malloc+0x1576>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	468080e7          	jalr	1128(ra) # 5f6a <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	ab250513          	addi	a0,a0,-1358 # 75c8 <malloc+0x15a6>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	44c080e7          	jalr	1100(ra) # 5f6a <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	abe50513          	addi	a0,a0,-1346 # 75f0 <malloc+0x15ce>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	430080e7          	jalr	1072(ra) # 5f6a <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	ac250513          	addi	a0,a0,-1342 # 7610 <malloc+0x15ee>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	414080e7          	jalr	1044(ra) # 5f6a <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	ace50513          	addi	a0,a0,-1330 # 7638 <malloc+0x1616>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	3f8080e7          	jalr	1016(ra) # 5f6a <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	ada50513          	addi	a0,a0,-1318 # 7660 <malloc+0x163e>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	3dc080e7          	jalr	988(ra) # 5f6a <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	aee50513          	addi	a0,a0,-1298 # 7690 <malloc+0x166e>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	3c0080e7          	jalr	960(ra) # 5f6a <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	afa50513          	addi	a0,a0,-1286 # 76b8 <malloc+0x1696>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	3a4080e7          	jalr	932(ra) # 5f6a <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	af650513          	addi	a0,a0,-1290 # 76d0 <malloc+0x16ae>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	388080e7          	jalr	904(ra) # 5f6a <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	afa50513          	addi	a0,a0,-1286 # 76f0 <malloc+0x16ce>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	36c080e7          	jalr	876(ra) # 5f6a <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	afe50513          	addi	a0,a0,-1282 # 7710 <malloc+0x16ee>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	350080e7          	jalr	848(ra) # 5f6a <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	b2250513          	addi	a0,a0,-1246 # 7750 <malloc+0x172e>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	334080e7          	jalr	820(ra) # 5f6a <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	b3650513          	addi	a0,a0,-1226 # 7780 <malloc+0x175e>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	318080e7          	jalr	792(ra) # 5f6a <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	b3a50513          	addi	a0,a0,-1222 # 77a0 <malloc+0x177e>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	2fc080e7          	jalr	764(ra) # 5f6a <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	b3e50513          	addi	a0,a0,-1218 # 77c0 <malloc+0x179e>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	2e0080e7          	jalr	736(ra) # 5f6a <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	b4250513          	addi	a0,a0,-1214 # 77e0 <malloc+0x17be>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	2c4080e7          	jalr	708(ra) # 5f6a <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	b5650513          	addi	a0,a0,-1194 # 7810 <malloc+0x17ee>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	2a8080e7          	jalr	680(ra) # 5f6a <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b6250513          	addi	a0,a0,-1182 # 7838 <malloc+0x1816>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	28c080e7          	jalr	652(ra) # 5f6a <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b6e50513          	addi	a0,a0,-1170 # 7860 <malloc+0x183e>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	270080e7          	jalr	624(ra) # 5f6a <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b7a50513          	addi	a0,a0,-1158 # 7888 <malloc+0x1866>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	254080e7          	jalr	596(ra) # 5f6a <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b7e50513          	addi	a0,a0,-1154 # 78a8 <malloc+0x1886>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	238080e7          	jalr	568(ra) # 5f6a <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b8250513          	addi	a0,a0,-1150 # 78c8 <malloc+0x18a6>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	21c080e7          	jalr	540(ra) # 5f6a <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b8e50513          	addi	a0,a0,-1138 # 78f0 <malloc+0x18ce>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	200080e7          	jalr	512(ra) # 5f6a <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b9250513          	addi	a0,a0,-1134 # 7910 <malloc+0x18ee>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	1e4080e7          	jalr	484(ra) # 5f6a <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b9650513          	addi	a0,a0,-1130 # 7930 <malloc+0x190e>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	1c8080e7          	jalr	456(ra) # 5f6a <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	ba250513          	addi	a0,a0,-1118 # 7958 <malloc+0x1936>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	1ac080e7          	jalr	428(ra) # 5f6a <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	81e50513          	addi	a0,a0,-2018 # 75f0 <malloc+0x15ce>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	190080e7          	jalr	400(ra) # 5f6a <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b8a50513          	addi	a0,a0,-1142 # 7978 <malloc+0x1956>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	174080e7          	jalr	372(ra) # 5f6a <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b8e50513          	addi	a0,a0,-1138 # 7998 <malloc+0x1976>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	158080e7          	jalr	344(ra) # 5f6a <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	ba250513          	addi	a0,a0,-1118 # 79c8 <malloc+0x19a6>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	13c080e7          	jalr	316(ra) # 5f6a <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	ba650513          	addi	a0,a0,-1114 # 79e8 <malloc+0x19c6>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	120080e7          	jalr	288(ra) # 5f6a <printf>
    exit(1);
    3e52:	4505                	li	a0,1
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	b9850513          	addi	a0,a0,-1128 # 7a00 <malloc+0x19de>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b8650513          	addi	a0,a0,-1146 # 7a00 <malloc+0x19de>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	9a450513          	addi	a0,a0,-1628 # 6830 <malloc+0x80e>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	5ba50513          	addi	a0,a0,1466 # 7458 <malloc+0x1436>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	55050513          	addi	a0,a0,1360 # 7400 <malloc+0x13de>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	ba650513          	addi	a0,a0,-1114 # 7a68 <malloc+0x1a46>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	bbc50513          	addi	a0,a0,-1092 # 7a90 <malloc+0x1a6e>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b1a50513          	addi	a0,a0,-1254 # 7a00 <malloc+0x19de>
    ...
    3f08:	b0450513          	addi	a0,a0,-1276 # 7a08 <malloc+0x19e6>
    3f0c:	00002097          	auipc	ra,0x2
    3f10:	05e080e7          	jalr	94(ra) # 5f6a <printf>
    exit(1);
    3f14:	4505                	li	a0,1
    ...
    3f24:	b0050513          	addi	a0,a0,-1280 # 7a20 <malloc+0x19fe>
    3f28:	00002097          	auipc	ra,0x2
    3f2c:	042080e7          	jalr	66(ra) # 5f6a <printf>
    exit(1);
    3f30:	4505                	li	a0,1
    ...
    3f40:	afc50513          	addi	a0,a0,-1284 # 7a38 <malloc+0x1a16>
    3f44:	00002097          	auipc	ra,0x2
    3f48:	026080e7          	jalr	38(ra) # 5f6a <printf>
    exit(1);
    3f4c:	4505                	li	a0,1
    ...
    3f5c:	af850513          	addi	a0,a0,-1288 # 7a50 <malloc+0x1a2e>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	00a080e7          	jalr	10(ra) # 5f6a <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	49450513          	addi	a0,a0,1172 # 7408 <malloc+0x13e6>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	fee080e7          	jalr	-18(ra) # 5f6a <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	ae050513          	addi	a0,a0,-1312 # 7a70 <malloc+0x1a4e>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	fd2080e7          	jalr	-46(ra) # 5f6a <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	aec50513          	addi	a0,a0,-1300 # 7a98 <malloc+0x1a76>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	fb6080e7          	jalr	-74(ra) # 5f6a <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	af050513          	addi	a0,a0,-1296 # 7ab8 <malloc+0x1a96>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	f9a080e7          	jalr	-102(ra) # 5f6a <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	ae450513          	addi	a0,a0,-1308 # 7ad8 <malloc+0x1ab6>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	ac850513          	addi	a0,a0,-1336 # 7ad8 <malloc+0x1ab6>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	afc50513          	addi	a0,a0,-1284 # 7b20 <malloc+0x1afe>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	ae450513          	addi	a0,a0,-1308 # 7b20 <malloc+0x1afe>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	ad050513          	addi	a0,a0,-1328 # 7b20 <malloc+0x1afe>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	abc50513          	addi	a0,a0,-1348 # 7b20 <malloc+0x1afe>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	aa858593          	addi	a1,a1,-1368 # 7b20 <malloc+0x1afe>
    4080:	00002517          	auipc	a0,0x2
    4084:	2a050513          	addi	a0,a0,672 # 6320 <malloc+0x2fe>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a4450513          	addi	a0,a0,-1468 # 7ad8 <malloc+0x1ab6>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	78650513          	addi	a0,a0,1926 # 6830 <malloc+0x80e>
  ...
  fd = open(".", 0);
    ...
    40c4:	77050513          	addi	a0,a0,1904 # 6830 <malloc+0x80e>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	0e458593          	addi	a1,a1,228 # 61b8 <malloc+0x196>
  ...
  close(fd);
    ...
    4104:	9e050513          	addi	a0,a0,-1568 # 7ae0 <malloc+0x1abe>
    4108:	00002097          	auipc	ra,0x2
    410c:	e62080e7          	jalr	-414(ra) # 5f6a <printf>
    exit(1);
    4110:	4505                	li	a0,1
    ...
    4120:	9e450513          	addi	a0,a0,-1564 # 7b00 <malloc+0x1ade>
    4124:	00002097          	auipc	ra,0x2
    4128:	e46080e7          	jalr	-442(ra) # 5f6a <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    413c:	9f850513          	addi	a0,a0,-1544 # 7b30 <malloc+0x1b0e>
    4140:	00002097          	auipc	ra,0x2
    4144:	e2a080e7          	jalr	-470(ra) # 5f6a <printf>
    exit(1);
    4148:	4505                	li	a0,1
    ...
    4158:	9dc50513          	addi	a0,a0,-1572 # 7b30 <malloc+0x1b0e>
    415c:	00002097          	auipc	ra,0x2
    4160:	e0e080e7          	jalr	-498(ra) # 5f6a <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	9e850513          	addi	a0,a0,-1560 # 7b58 <malloc+0x1b36>
    4178:	00002097          	auipc	ra,0x2
    417c:	df2080e7          	jalr	-526(ra) # 5f6a <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9f450513          	addi	a0,a0,-1548 # 7b80 <malloc+0x1b5e>
    4194:	00002097          	auipc	ra,0x2
    4198:	dd6080e7          	jalr	-554(ra) # 5f6a <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	a0050513          	addi	a0,a0,-1536 # 7ba8 <malloc+0x1b86>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	dba080e7          	jalr	-582(ra) # 5f6a <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	a0c50513          	addi	a0,a0,-1524 # 7bd0 <malloc+0x1bae>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	d9e080e7          	jalr	-610(ra) # 5f6a <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	a1050513          	addi	a0,a0,-1520 # 7bf0 <malloc+0x1bce>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d82080e7          	jalr	-638(ra) # 5f6a <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	a1c50513          	addi	a0,a0,-1508 # 7c18 <malloc+0x1bf6>
    4204:	00002097          	auipc	ra,0x2
    4208:	d66080e7          	jalr	-666(ra) # 5f6a <printf>
    exit(1);
    420c:	4505                	li	a0,1
...
0000000000004216 <iref>:
{
    ...
    4234:	a00a0a13          	addi	s4,s4,-1536 # 7c30 <malloc+0x1c0e>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	50048493          	addi	s1,s1,1280 # 7738 <malloc+0x1716>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0e0a8a93          	addi	s5,s5,224 # 6320 <malloc+0x2fe>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8e098993          	addi	s3,s3,-1824 # 7b28 <malloc+0x1b06>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9e450513          	addi	a0,a0,-1564 # 7c38 <malloc+0x1c16>
    425c:	00002097          	auipc	ra,0x2
    4260:	d0e080e7          	jalr	-754(ra) # 5f6a <printf>
      exit(1);
    4264:	4505                	li	a0,1
    ...
    4274:	9e050513          	addi	a0,a0,-1568 # 7c50 <malloc+0x1c2e>
    4278:	00002097          	auipc	ra,0x2
    427c:	cf2080e7          	jalr	-782(ra) # 5f6a <printf>
      exit(1);
    4280:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	15498993          	addi	s3,s3,340 # 7458 <malloc+0x1436>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	92490913          	addi	s2,s2,-1756 # 7c30 <malloc+0x1c0e>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	0d450513          	addi	a0,a0,212 # 7400 <malloc+0x13de>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	90c50513          	addi	a0,a0,-1780 # 7c68 <malloc+0x1c46>
  ...
  if(pid == 0){
    ...
    4384:	8e850513          	addi	a0,a0,-1816 # 7c68 <malloc+0x1c46>
    ...
    439a:	8f250513          	addi	a0,a0,-1806 # 7c88 <malloc+0x1c66>
    439e:	00002097          	auipc	ra,0x2
    43a2:	bcc080e7          	jalr	-1076(ra) # 5f6a <printf>
      exit(1);
    43a6:	4505                	li	a0,1
    ...
    43b6:	8be50513          	addi	a0,a0,-1858 # 7c70 <malloc+0x1c4e>
    43ba:	00002097          	auipc	ra,0x2
    43be:	bb0080e7          	jalr	-1104(ra) # 5f6a <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43d2:	60250513          	addi	a0,a0,1538 # 69d0 <malloc+0x9ae>
    43d6:	00002097          	auipc	ra,0x2
    43da:	b94080e7          	jalr	-1132(ra) # 5f6a <printf>
    exit(1);
    43de:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	86c50513          	addi	a0,a0,-1940 # 7c68 <malloc+0x1c46>
    ...
    4414:	7b050513          	addi	a0,a0,1968 # 6bc0 <malloc+0xb9e>
    4418:	00002097          	auipc	ra,0x2
    441c:	b52080e7          	jalr	-1198(ra) # 5f6a <printf>
    exit(1);
    4420:	4505                	li	a0,1
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	86250513          	addi	a0,a0,-1950 # 7cb0 <malloc+0x1c8e>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	83650513          	addi	a0,a0,-1994 # 7cb0 <malloc+0x1c8e>
  ...
  sleep(10); // one second
    ...
    44b6:	6de50513          	addi	a0,a0,1758 # 6b90 <malloc+0xb6e>
    44ba:	00002097          	auipc	ra,0x2
    44be:	ab0080e7          	jalr	-1360(ra) # 5f6a <printf>
    exit(1);
    44c2:	4505                	li	a0,1
    ...
    44d0:	7e448493          	addi	s1,s1,2020 # 7cb0 <malloc+0x1c8e>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
0000000000004512 <killstatus>:
{
  ...
  exit(0);
    ...
    4578:	45c50513          	addi	a0,a0,1116 # 69d0 <malloc+0x9ae>
    457c:	00002097          	auipc	ra,0x2
    4580:	9ee080e7          	jalr	-1554(ra) # 5f6a <printf>
      exit(1);
    4584:	4505                	li	a0,1
    ...
    459e:	72650513          	addi	a0,a0,1830 # 7cc0 <malloc+0x1c9e>
    45a2:	00002097          	auipc	ra,0x2
    45a6:	9c8080e7          	jalr	-1592(ra) # 5f6a <printf>
       exit(1);
    45aa:	4505                	li	a0,1
...
00000000000045b4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45de:	5b650513          	addi	a0,a0,1462 # 6b90 <malloc+0xb6e>
    45e2:	00002097          	auipc	ra,0x2
    45e6:	988080e7          	jalr	-1656(ra) # 5f6a <printf>
    exit(1);
    45ea:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    460c:	3c850513          	addi	a0,a0,968 # 69d0 <malloc+0x9ae>
    4610:	00002097          	auipc	ra,0x2
    4614:	95a080e7          	jalr	-1702(ra) # 5f6a <printf>
    exit(1);
    4618:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4650:	b6c58593          	addi	a1,a1,-1172 # 61b8 <malloc+0x196>
    ...
    467a:	35a50513          	addi	a0,a0,858 # 69d0 <malloc+0x9ae>
    467e:	00002097          	auipc	ra,0x2
    4682:	8ec080e7          	jalr	-1812(ra) # 5f6a <printf>
     exit(1);
    4686:	4505                	li	a0,1
    ...
    4696:	64e50513          	addi	a0,a0,1614 # 7ce0 <malloc+0x1cbe>
    469a:	00002097          	auipc	ra,0x2
    469e:	8d0080e7          	jalr	-1840(ra) # 5f6a <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d2:	62a50513          	addi	a0,a0,1578 # 7cf8 <malloc+0x1cd6>
    46d6:	00002097          	auipc	ra,0x2
    46da:	894080e7          	jalr	-1900(ra) # 5f6a <printf>
}
  ...
  printf("kill... ");
    ...
    46fe:	61650513          	addi	a0,a0,1558 # 7d10 <malloc+0x1cee>
    4702:	00002097          	auipc	ra,0x2
    4706:	868080e7          	jalr	-1944(ra) # 5f6a <printf>
  kill(pid1);
    470a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    472c:	5f850513          	addi	a0,a0,1528 # 7d20 <malloc+0x1cfe>
    4730:	00002097          	auipc	ra,0x2
    4734:	83a080e7          	jalr	-1990(ra) # 5f6a <printf>
  wait(0);
    4738:	4501                	li	a0,0
...
0000000000004758 <reparent>:
{
  ...
  exit(0);
    ...
    47ac:	22850513          	addi	a0,a0,552 # 69d0 <malloc+0x9ae>
    47b0:	00001097          	auipc	ra,0x1
    47b4:	7ba080e7          	jalr	1978(ra) # 5f6a <printf>
      exit(1);
    47b8:	4505                	li	a0,1
    ...
    47c8:	39450513          	addi	a0,a0,916 # 6b58 <malloc+0xb36>
    47cc:	00001097          	auipc	ra,0x1
    47d0:	79e080e7          	jalr	1950(ra) # 5f6a <printf>
        exit(1);
    47d4:	4505                	li	a0,1
...
0000000000004808 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    483e:	29e50513          	addi	a0,a0,670 # 6ad8 <malloc+0xab6>
    4842:	00001097          	auipc	ra,0x1
    4846:	728080e7          	jalr	1832(ra) # 5f6a <printf>
    exit(1);
    484a:	4505                	li	a0,1
    ...
    4872:	94a58593          	addi	a1,a1,-1718 # 61b8 <malloc+0x196>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4936:	3fe50513          	addi	a0,a0,1022 # 7d30 <malloc+0x1d0e>
    493a:	00001097          	auipc	ra,0x1
    493e:	630080e7          	jalr	1584(ra) # 5f6a <printf>
    exit(1);
    4942:	4505                	li	a0,1
    ...
    4952:	08250513          	addi	a0,a0,130 # 69d0 <malloc+0x9ae>
    4956:	00001097          	auipc	ra,0x1
    495a:	614080e7          	jalr	1556(ra) # 5f6a <printf>
    exit(1);
    495e:	4505                	li	a0,1
    ...
    499e:	3b650513          	addi	a0,a0,950 # 7d50 <malloc+0x1d2e>
    49a2:	00001097          	auipc	ra,0x1
    49a6:	5c8080e7          	jalr	1480(ra) # 5f6a <printf>
    exit(1);
    49aa:	4505                	li	a0,1
...
00000000000049be <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a08:	61e080e7          	jalr	1566(ra) # 6022 <malloc>
    ...
    4a42:	34250513          	addi	a0,a0,834 # 7d80 <malloc+0x1d5e>
    4a46:	00001097          	auipc	ra,0x1
    4a4a:	524080e7          	jalr	1316(ra) # 5f6a <printf>
      exit(1);
    4a4e:	4505                	li	a0,1
...
0000000000004a62 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4af8:	2bc50513          	addi	a0,a0,700 # 7db0 <malloc+0x1d8e>
    4afc:	00001097          	auipc	ra,0x1
    4b00:	46e080e7          	jalr	1134(ra) # 5f6a <printf>
    exit(1);
    4b04:	4505                	li	a0,1
    ...
    4b14:	2c850513          	addi	a0,a0,712 # 7dd8 <malloc+0x1db6>
    4b18:	00001097          	auipc	ra,0x1
    4b1c:	452080e7          	jalr	1106(ra) # 5f6a <printf>
      exit(1);
    4b20:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	24c50513          	addi	a0,a0,588 # 7da0 <malloc+0x1d7e>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b98:	26450513          	addi	a0,a0,612 # 7df8 <malloc+0x1dd6>
    4b9c:	00001097          	auipc	ra,0x1
    4ba0:	3ce080e7          	jalr	974(ra) # 5f6a <printf>
    exit(1);
    4ba4:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bd4:	1d050513          	addi	a0,a0,464 # 7da0 <malloc+0x1d7e>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4bfa:	22a50513          	addi	a0,a0,554 # 7e20 <malloc+0x1dfe>
    4bfe:	00001097          	auipc	ra,0x1
    4c02:	36c080e7          	jalr	876(ra) # 5f6a <printf>
    exit(1);
    4c06:	4505                	li	a0,1
...
0000000000004c1a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c40:	1fc78793          	addi	a5,a5,508 # 7e38 <malloc+0x1e16>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	1f878793          	addi	a5,a5,504 # 7e40 <malloc+0x1e1e>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	1f478793          	addi	a5,a5,500 # 7e48 <malloc+0x1e26>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	1f078793          	addi	a5,a5,496 # 7e50 <malloc+0x1e2e>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cdc:	10050513          	addi	a0,a0,256 # 6dd8 <malloc+0xdb6>
    4ce0:	00001097          	auipc	ra,0x1
    4ce4:	28a080e7          	jalr	650(ra) # 5f6a <printf>
      exit(1);
    4ce8:	4505                	li	a0,1
    ...
    4d58:	10450513          	addi	a0,a0,260 # 7e58 <malloc+0x1e36>
    4d5c:	00001097          	auipc	ra,0x1
    4d60:	20e080e7          	jalr	526(ra) # 5f6a <printf>
        exit(1);
    4d64:	4505                	li	a0,1
    ...
    4d72:	0fa50513          	addi	a0,a0,250 # 7e68 <malloc+0x1e46>
    4d76:	00001097          	auipc	ra,0x1
    4d7a:	1f4080e7          	jalr	500(ra) # 5f6a <printf>
          exit(1);
    4d7e:	4505                	li	a0,1
    ...
    4d9a:	0ea50513          	addi	a0,a0,234 # 7e80 <malloc+0x1e5e>
    4d9e:	00001097          	auipc	ra,0x1
    4da2:	1cc080e7          	jalr	460(ra) # 5f6a <printf>
          exit(1);
    4da6:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e28:	06c50513          	addi	a0,a0,108 # 7e90 <malloc+0x1e6e>
    4e2c:	00001097          	auipc	ra,0x1
    4e30:	13e080e7          	jalr	318(ra) # 5f6a <printf>
      exit(1);
    4e34:	4505                	li	a0,1
...
0000000000004e5c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8a:	022b8b93          	addi	s7,s7,34 # 7ea8 <malloc+0x1e86>
  for(i = 0; i < N; i++){
    ...
    4ecc:	fe850513          	addi	a0,a0,-24 # 7eb0 <malloc+0x1e8e>
    4ed0:	00001097          	auipc	ra,0x1
    4ed4:	09a080e7          	jalr	154(ra) # 5f6a <printf>
        exit(1);
    4ed8:	4505                	li	a0,1
    ...
    4eea:	fc250513          	addi	a0,a0,-62 # 7ea8 <malloc+0x1e86>
  ...
  fd = open(".", 0);
    ...
    4f22:	91250513          	addi	a0,a0,-1774 # 6830 <malloc+0x80e>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9a:	f3a50513          	addi	a0,a0,-198 # 7ed0 <malloc+0x1eae>
    4f9e:	00001097          	auipc	ra,0x1
    4fa2:	fcc080e7          	jalr	-52(ra) # 5f6a <printf>
        exit(1);
    4fa6:	4505                	li	a0,1
    ...
    4fba:	f3a50513          	addi	a0,a0,-198 # 7ef0 <malloc+0x1ece>
    4fbe:	00001097          	auipc	ra,0x1
    4fc2:	fac080e7          	jalr	-84(ra) # 5f6a <printf>
        exit(1);
    4fc6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4ff2:	f2a50513          	addi	a0,a0,-214 # 7f18 <malloc+0x1ef6>
    4ff6:	00001097          	auipc	ra,0x1
    4ffa:	f74080e7          	jalr	-140(ra) # 5f6a <printf>
    exit(1);
    4ffe:	4505                	li	a0,1
    ...
    500e:	9c650513          	addi	a0,a0,-1594 # 69d0 <malloc+0x9ae>
    5012:	00001097          	auipc	ra,0x1
    5016:	f58080e7          	jalr	-168(ra) # 5f6a <printf>
      exit(1);
    501a:	4505                	li	a0,1
...
00000000000051b8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	d1450513          	addi	a0,a0,-748 # 7f50 <malloc+0x1f2e>
  ...
  for(i = 0; ; i++){
    ...
    52a4:	cc050513          	addi	a0,a0,-832 # 7f60 <malloc+0x1f3e>
    52a8:	00001097          	auipc	ra,0x1
    52ac:	cc2080e7          	jalr	-830(ra) # 5f6a <printf>
    exit(1);
    52b0:	4505                	li	a0,1
    ...
    52c0:	cc450513          	addi	a0,a0,-828 # 7f80 <malloc+0x1f5e>
    52c4:	00001097          	auipc	ra,0x1
    52c8:	ca6080e7          	jalr	-858(ra) # 5f6a <printf>
      exit(1);
    52cc:	4505                	li	a0,1
    ...
    52dc:	cc850513          	addi	a0,a0,-824 # 7fa0 <malloc+0x1f7e>
    52e0:	00001097          	auipc	ra,0x1
    52e4:	c8a080e7          	jalr	-886(ra) # 5f6a <printf>
    exit(1);
    52e8:	4505                	li	a0,1
    ...
    52f8:	ccc50513          	addi	a0,a0,-820 # 7fc0 <malloc+0x1f9e>
    52fc:	00001097          	auipc	ra,0x1
    5300:	c6e080e7          	jalr	-914(ra) # 5f6a <printf>
      exit(1);
    5304:	4505                	li	a0,1
    ...
    5314:	cd050513          	addi	a0,a0,-816 # 7fe0 <malloc+0x1fbe>
    5318:	00001097          	auipc	ra,0x1
    531c:	c52080e7          	jalr	-942(ra) # 5f6a <printf>
      exit(1);
    5320:	4505                	li	a0,1
    ...
    5330:	ccc50513          	addi	a0,a0,-820 # 7ff8 <malloc+0x1fd6>
    5334:	00001097          	auipc	ra,0x1
    5338:	c36080e7          	jalr	-970(ra) # 5f6a <printf>
      exit(1);
    533c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    535e:	bf650513          	addi	a0,a0,-1034 # 7f50 <malloc+0x1f2e>
    ...
    5382:	c9a50513          	addi	a0,a0,-870 # 8018 <malloc+0x1ff6>
    5386:	00001097          	auipc	ra,0x1
    538a:	be4080e7          	jalr	-1052(ra) # 5f6a <printf>
    exit(1);
    538e:	4505                	li	a0,1
...
0000000000005398 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53ba:	c8250513          	addi	a0,a0,-894 # 8038 <malloc+0x2016>
    53be:	00001097          	auipc	ra,0x1
    53c2:	bac080e7          	jalr	-1108(ra) # 5f6a <printf>
  for(nfiles = 0; ; nfiles++){
    53c6:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53da:	c72c8c93          	addi	s9,s9,-910 # 8048 <malloc+0x2026>
    int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5432:	b3c080e7          	jalr	-1220(ra) # 5f6a <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5454:	c0850513          	addi	a0,a0,-1016 # 8058 <malloc+0x2036>
    5458:	00001097          	auipc	ra,0x1
    545c:	b12080e7          	jalr	-1262(ra) # 5f6a <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	bb250513          	addi	a0,a0,-1102 # 8078 <malloc+0x2056>
    54ce:	00001097          	auipc	ra,0x1
    54d2:	a9c080e7          	jalr	-1380(ra) # 5f6a <printf>
}
    ...
    551a:	b5250513          	addi	a0,a0,-1198 # 8068 <malloc+0x2046>
    551e:	00001097          	auipc	ra,0x1
    5522:	a4c080e7          	jalr	-1460(ra) # 5f6a <printf>
    close(fd);
    5526:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cd8:	91450513          	addi	a0,a0,-1772 # 85e8 <digits>
    5cdc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d98:	7fcc8c93          	addi	s9,s9,2044 # 8590 <malloc+0x256e>
  ...
  putc(fd, 'x');
    ...
    5da6:	846b8b93          	addi	s7,s7,-1978 # 85e8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ecc:	6c098993          	addi	s3,s3,1728 # 8588 <malloc+0x2566>
        while(*s != 0){
    5ed0:	85ee                	mv	a1,s11
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5fae:	4a67b783          	ld	a5,1190(a5) # 9450 <freep>
    ...
    5fd6:	00e6ea63          	bltu	a3,a4,5fea <free+0x4a>
{
  ...
  freep = p;
    ...
    6018:	42f73e23          	sd	a5,1084(a4) # 9450 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    604a:	40a53503          	ld	a0,1034(a0) # 9450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    6072:	3e290913          	addi	s2,s2,994 # 9450 <freep>
  if(p == (char*)-1)
    6076:	5afd                	li	s5,-1
    6078:	a895                	j	60ec <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    607a:	0000a797          	auipc	a5,0xa
    607e:	bfe78793          	addi	a5,a5,-1026 # fc78 <base>
    6082:	00003717          	auipc	a4,0x3
    6086:	3cf73723          	sd	a5,974(a4) # 9450 <freep>
    ...
    60ae:	3aa73323          	sd	a0,934(a4) # 9450 <freep>
      return (void*)(p + 1);
