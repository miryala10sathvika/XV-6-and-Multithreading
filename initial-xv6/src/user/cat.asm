...
cat(int fd)
{
  ...
  44:	8b058593          	addi	a1,a1,-1872 # 8f0 <malloc+0xea>
  48:	4509                	li	a0,2
  ...
  72:	89a58593          	addi	a1,a1,-1894 # 908 <malloc+0x102>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	81e58593          	addi	a1,a1,-2018 # 920 <malloc+0x11a>
 10a:	4509                	li	a0,2
...
putc(int fd, char c)
{
 ...
 48a:	f3e080e7          	jalr	-194(ra) # 3c4 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4bc:	4e050513          	addi	a0,a0,1248 # 998 <digits>
 4c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 57c:	3c8c8c93          	addi	s9,s9,968 # 940 <malloc+0x13a>
 ...
 58a:	412b8b93          	addi	s7,s7,1042 # 998 <digits>
 ...
 6b0:	28c98993          	addi	s3,s3,652 # 938 <malloc+0x132>
        while(*s != 0){
 6b4:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 8e0:	b50080e7          	jalr	-1200(ra) # 42c <sbrk>
  if(p == (char*)-1)
