...
main(int argc, char *argv[]) {
  ...
  6a:	7ea50513          	addi	a0,a0,2026 # 850 <malloc+0xf0>
  6e:	00000097          	auipc	ra,0x0
  72:	63a080e7          	jalr	1594(ra) # 6a8 <printf>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d6:	39ec8c93          	addi	s9,s9,926 # 870 <malloc+0x110>
 ...
 4e4:	3e8b8b93          	addi	s7,s7,1000 # 8c8 <digits>
 ...
 60a:	26298993          	addi	s3,s3,610 # 868 <malloc+0x108>
        while(*s != 0){
 60e:	85ee                	mv	a1,s11
